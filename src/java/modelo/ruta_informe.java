...
public class ruta_informe{
    ...
    public ruta_informe(int id_informe, int id_lugarpartida, int id_lugarllegada, String tipo_transporte, String nombre_transporte, java.sql.Date fecha_salida, String hora_salida, java.sql.Date fecha_llegada, String hora_llegada) {
    ...
    public String toString() {
        return "ruta_informe{" + "id_ruta=" + id_ruta + ", id_informe=" + id_informe + ", id_lugarpartida=" + id_lugarpartida + ", id_lugarllegada=" + id_lugarllegada + ", tipo_transporte=" + tipo_transporte + ", nombre_transporte=" + nombre_transporte + ", fecha_salida=" + fecha_salida + ", hora_salida=" + hora_salida + ", fecha_llegada=" + fecha_llegada + ", hora_llegada=" + hora_llegada + '}';
    }
