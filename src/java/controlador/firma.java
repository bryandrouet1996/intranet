 ...
 * @author Kevin Druet
 */
@WebServlet(name = "firma", urlPatterns = {"/firma.control"})
public class firma extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(request.getParameter("iu"));
        String firma = enlace.buscarFirmaUsuarioID(id);
        File ima = new File(firma);
        if (!firma.equals("ninguno")) {
