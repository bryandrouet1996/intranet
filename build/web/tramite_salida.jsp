...
<%
    ...
    ArrayList<tramite> listadoEnviado = null, listadoDevueltos = null;
    java.sql.Date fecha_inicio = null, fecha_fin = null;
    ArrayList<tipo_tramite> listadoTipos = null;
    try {
        ...
        listadoTipos = enlace.listadoTipoTramite();
        ...
        listadoEnviado = request.getParameter("txtini") == null ? enlace.getListadoTramitesSalida(informacion.getId_usuario(), false) : enlace.getListadoTramitesSalida(informacion.getId_usuario(), false, fecha_inicio, fecha_fin);
        listadoDevueltos = request.getParameter("txtini") == null ? enlace.getListadoTramitesSalida(informacion.getId_usuario(), true) : enlace.getListadoTramitesSalida(informacion.getId_usuario(), true, fecha_inicio, fecha_fin);
    } catch (Exception e) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Listado de trámites enviados</title>
        <!-- General CSS Files -->
    ...
    <body>
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Trámites enviados</h1>
                            <div class="section-header-breadcrumb">
                                <div class="flex-column activities">
                                    <a href="sesion.control?accion=tramite_nuevo&iu=<%=informacion.getId_usuario()%>" class="btn btn-primary" > <i class="fas fa-plus"></i> Ingresar nuevo</a>   
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true"><i class="fas fa-share"></i> Enviados <%if(listadoEnviado.size()!=0){%><span class="badge badge-primary"><%= listadoEnviado.size() %></span><%}%></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="devueltos-tab" data-toggle="tab" href="#devueltos" role="tab" aria-controls="devueltos" aria-selected="false"><i class="fas fa-undo"></i> Devueltos <%if(listadoDevueltos.size()!=0){%><span class="badge badge-primary"><%= listadoDevueltos.size() %></span><%}%></a>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-x">
                                                            ...
                                                            <tbody>
                                                                <%for(tramite enviado:listadoEnviado){
                                                                    usuario destinatario = enlace.buscar_usuarioID(enviado.getId_para());
                                                                %>
                                                                <tr>
                                                                    <td><%= "TRA-" + enviado.getId_tramite() %></td>
                                                                    <td><%= enviado.getFecha_elaboracion() %></td>
                                                                    <td><%= enviado.getHora_elaboracion() %></td>
                                                                    <td><%= enviado.getNumero_memorando() %></td>
                                                                    <td><%=enlace.getTipoTramite(enviado.getTipo_tramite()).getDescripcion()%></td>
                                                                    <td><%= destinatario.getNombre() %> <%= destinatario.getApellido() %></td>
                                                                    <td>
                                                                        <a href="javascript:" data-toggle="modal" data-target="#modalDetalleTramite" class="btn btn-primary btn-sm" data-fecha="<%= enviado.getFecha_elaboracion()%>" data-hora="<%= enviado.getHora_elaboracion()%>" data-numero="<%= enviado.getNumero_memorando()%>" data-tipo="<%= enlace.getTipoTramite(enviado.getTipo_tramite()).getDescripcion()%>" data-asun="<%= enviado.getAsunto()%>" data-dest="<%= destinatario.getNombre() + " " + destinatario.getApellido()%>"><i class="fas fa-eye" data-toggle="tooltip" data-original-title="Ver detalles" ></i></a>
                                                                        <a href="administrar_tramite.control?accion=descargar_documento&id_tramite=<%= enviado.getId_tramite() %>" target="_blank" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Descargar"><i class="fas fa-cloud-download-alt"></i></a>
                                                                        <%if(enviado.getId_estado() == 0){%>
                                                                            <a onclick="eliminarTramite(<%= enviado.getId_tramite()%>)" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Eliminar" ><i class="fas fa-trash" style="color: white"></i></a>
                                                                        <%}%>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                ...
                                                <div class="tab-pane fade" id="devueltos" role="tabpanel" aria-labelledby="devueltos-tab">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-xx">
                                                            ...
                                                            <tbody>
                                                                <%for(tramite devuelto : listadoDevueltos){
                                                                    usuario destinatario = enlace.buscar_usuarioID(devuelto.getId_para());
                                                                %>
                                                                <tr>
                                                                    <td><%= "TRA-" + devuelto.getId_tramite() %></td>
                                                                    <td><%= devuelto.getFecha_elaboracion() %></td>
                                                                    <td><%= devuelto.getHora_elaboracion() %></td>
                                                                    <td><%= devuelto.getNumero_memorando() %></td>
                                                                    <td><%= enlace.getTipoTramite(devuelto.getTipo_tramite()).getDescripcion()%></td>
                                                                    <td><%= destinatario.getNombre() %> <%= destinatario.getApellido() %></td>
                                                                    <td>
                                                                        <a href="javascript:" data-toggle="modal" data-target="#modalDetalleDevuelto" class="btn btn-primary btn-sm" data-fecha="<%= devuelto.getFecha_update()%>" data-numero="<%= devuelto.getNumero_memorando()%>" data-tipo="<%= enlace.getTipoTramite(devuelto.getTipo_tramite()).getDescripcion()%>" data-dest="<%= destinatario.getNombre() + " " + destinatario.getApellido()%>" data-moti="<%= devuelto.getDevuelto()%>" ><i class="fas fa-eye" data-toggle="tooltip" data-original-title="Ver devolución"></i></a>
                                                                        <a href="javascript:" type="button" data-toggle="modal" data-target="#modalActualizarAdjunto" data-id="<%= devuelto.getId_tramite()%>" data-numero="<%= devuelto.getNumero_memorando()%>" data-tipo="<%= devuelto.getTipo_tramite()%>" data-asun="<%= devuelto.getAsunto()%>" class="btn btn-primary btn-sm active"><i class="fas fa-upload" data-toggle="tooltip" data-original-title="Actualizar adjunto y reenviar"></i></a>
                                                                        <a href="administrar_tramite.control?accion=descargar_documento&id_tramite=<%= devuelto.getId_tramite() %>" target="_blank" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Descargar"><i class="fas fa-cloud-download-alt"></i></a>
                                                                        <a onclick="eliminarTramite(<%= devuelto.getId_tramite()%>)" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Eliminar" ><i class="fas fa-trash" style="color: white"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
                                ...
                                <form class="needs-validation" novalidate="">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="Detalle claramente la problemática." name="dest" id="dest" required="" readonly="">
                                            <div class="invalid-feedback">
                                                No ha ninguna fecha
                                            </div>
                                        </div>
                ...
                <div class="modal fade" id="modalDetalleDevuelto" role="dialog">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">
                            ...
                            <div class="modal-body">
                                ...
                                <form class="needs-validation" novalidate="">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label>Tipo de trámite</label>
                                            <input type="text" class="form-control" name="tipo" id="tipo" required="" readonly="">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label>Destinatario</label>
                                            <input type="text" class="form-control" name="dest" id="dest" required="" readonly="">
                                        </div>                                        
                                        <div class="form-group col-md-12">
                                            <label>Motivo</label>
                                            <textarea type="text" class="form-control" name="moti" id="moti" required="" readonly=""></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                ...
                <div class="modal fade"  role="dialog" aria-hidden="true" id="modalActualizarAdjunto">
                    <div class="modal-dialog modal-lg" role="dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title text-center">
                                    <span class="fw-extrabold">
                                        Actualizar adjunto y reenviar
                                    </span>
                                </h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                            ...
                            <div class="modal-body">
                                <p class="small"></p>
                                <form id="formactualizaradjunto" action="administrar_tramite.control?accion=actualizar_adjunto" method="post" enctype="multipart/form-data" class="needs-validation">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" id="tipo" name="tipo" required="">
                                                <%for (tipo_tramite tipo : listadoTipos) {%>
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div class="invalid-feedback">
                                                No se ha cargado el adjunto
                                            </div>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label>Asunto *</label>
                                            <textarea type="text" class="form-control" name="asun" id="asun" required=""></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="submit" value="Upload" class="btn btn-primary" id="btnActualizar">Actualizar</button>
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                    </div>
                                </form>
                            </div>
        ...
        <script type="text/javascript">
            $('#modalDetalleTramite').on('show.bs.modal', function (event) {
                ...
                modal.find('.modal-body #dest').val(dest);
            })
            
            $('#modalDetalleDevuelto').on('show.bs.modal', function (event) {
                var button = $(event.relatedTarget);
                var fecha = button.data('fecha');                
                var numero = button.data('numero');
                var tipo = button.data('tipo');
                var dest = button.data('dest');
                var moti = button.data('moti');                
                var modal = $(this);
                modal.find('.modal-body #fecha').val(fecha);
                modal.find('.modal-body #numero').val(numero);
                modal.find('.modal-body #tipo').val(tipo);
                modal.find('.modal-body #dest').val(dest);
                modal.find('.modal-body #moti').val(moti);                
            })
            
            $('#modalActualizarAdjunto').on('show.bs.modal', function (event) {
                var button = $(event.relatedTarget);
        ...
        <script>
            ...
            $(document).ready(function () {
                $(document).ready(function () {
                    $('#formactualizaradjunto').submit(function (event) {
                            ...
                            success: function (response) {
                                if (response) {
                                    Swal.fire({
                                        ...
                                        location.href = "tramite_salida.jsp";
                                    });
                                } else {
                                    Swal.fire({
                                        title: "Error",
                                        text: "No se reenvió el trámite",
                                        icon: "error",
                                        buttonsStyling: false,
                                        customClass: {
                                            confirmButton: 'btn btn-success'
            ...
            function eliminarTramite(id_tramite) {
                Swal.fire({
                    title: '¿Desea eliminar este trámite?',
                    text: "Este trámite ya no será visible para el destinatario",
                    icon: 'warning',
                    buttonsStyling: false,
                    ...
                    if (willDelete.isConfirmed) {
                        ...
                        $.post('administrar_tramite.control?accion=eliminar_tramite', {
                            id_tramite: id_tramite
                        }, function (responseText) {
                            if (responseText) {
                                Swal.fire({
                                    title: 'El trámite fue eliminado',
                                    icon: "success",
                                    buttonsStyling: false,
                                    customClass: {
                                        confirmButton: 'btn btn-success'
                                ...
                                Swal.fire({
                                    ...
                                    text: "El trámite no fue eliminado",
                                    icon: "error",
                                    buttonsStyling: false,
                                    customClass: {
                                        confirmButton: 'btn btn-success'
