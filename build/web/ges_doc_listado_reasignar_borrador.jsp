...
<html lang="es">
    ...
    <body>
        ...
        <table class="table table-striped" id="table-x-reasignar">
            <thead>                                 
                <tr>
                    <th>Funcionario</th>
                    <th></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <a type="button" onclick="reasignar_borrador(<%= u.getId_usuario()%>)" class="btn btn-primary btn-sm active"><i class="fas fa-check-circle" data-toggle="tooltip" data-original-title="Reasignar"></i></a>
                    </td>
                </tr>
                <%}%>
            </tbody>
    ...
    <script type="text/javascript">
                           ...
                           function reasignar_borrador(nuevo_remitente) {
                               Swal.fire({
                                   title: "¿Deseas reasignar este documento?",
                                   icon: 'warning',
                                   ...
                                   if (result.isConfirmed) {
                                       ...
                                       $.post('administrar_documento.control?accion=reasignar_borrador', {
                                           id_documento: <%=id_documento%>,
                                           nuevo_remitente: nuevo_remitente
                                       }, function (response) {
