                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="table-1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><a href="asignacion_presupuesto.jsp?ipa=<%= plan.getId_plan() %>"><%= "PL-"+plan.getId_plan() %></a></td>
                                                            <td><%= plan.getAnio() %></td>
                                                            ...
                                                            <td width="100">
                                                                <%if(plan.getEstado()==0){%>
                                                                <a href="asignacion_presupuesto.jsp?ipa=<%= plan.getId_plan() %>" class="btn btn-primary btn-sm active"><i data-toggle="tooltip" data-original-title="Ver plan" class="fa fa-eye"></i></a>
                            ...
                            <div class="modal-body">
                                ...
                                <form id="formNuevoPlan" action="administrar_plan.control?accion=registrar_plan" enctype="multipart/form-data" class="needs-validation" novalidate="" method="post" >
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="txtpresupuesto">Presupuesto total</label>
