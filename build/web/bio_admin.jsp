<%@page import="modelo.AuditoriaAcceso"%>
...
<%
    ...
    try {
        ...
        if (!(mysql.verificarUsuarioCumpleRol(id, "administrador") || mysql.verificarUsuarioCumpleRol(id, "biometrico_admin"))) {
            throw new Exception("Rol no habilitado");
        }
        foto = mysql.buscarFotoUsuarioID(informacion.getId_usuario());
        listaModulos = mysql.listadoModulosTipoUsuarioID(informacion.getId_usuario());
        if (request.getParameter("listfun") != null) {
            listFun = request.getParameter("listfun");
        }
        ...
        listadoRegistradas = (fecha_inicio != null && fecha_fin != null) ? (!listFun.equals("0") ? bio.getAsistencias(listFun, fecha_inicio, fecha_fin) : bio.getAsistencias(fecha_inicio, fecha_fin)) : (!listFun.equals("0") ? bio.getAsistencias(listFun) : bio.getAsistencias());
        listadoUsu = oracle.getUsuariosActivosBiometrico();
        mysql.auditarAcceso(new AuditoriaAcceso(id, "BIO ADMIN"));
    } catch (Exception e) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Reportería de asistencias</title>
    ...
    <body>
            ...
            <div class="main-wrapper main-wrapper-1">
                ...
                <nav class="navbar navbar-expand-lg main-navbar">
                    ...
                    <ul class="navbar-nav navbar-right">
                        <li class=""><a target="_blank" href="https://www.esmeraldas.gob.ec:2096/login/?user=<%= informacion.getCorreo()%>&pass=<%= mysql.webmailClaveUsuario(informacion.getId_usuario())%>" class="nav-link nav-link-lg  beep"><i class="far fa-envelope"></i> Webmail</a>
                        </li>
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="menu-header">COMPONENTES</li>
                                <%for (modulo mod : listaModulos) {
                                        listaComponente = mysql.listadoComponentesTipoUsuarioID(informacion.getId_usuario(), mod.getId_modulo());
                                %>
                                <%if(mod.isBlank()){%>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <%for (componente item : listaComponente) {
                                            listaSubcomponente = mysql.listadoSubcomponentesTipoUsuarioID(informacion.getId_usuario(), item.getId_componente());
                                    %>
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Control de asistencia - Reportería de asistencias</h1>
                        </div>
                                        ...
                                        <div class="card-body">
                                            <form class="row" action="">
                                                ...
                                                <div class="form-group col-4">
                                                    ...
                                                    <select style="width: 100%" class="form-control select2" name="listfun" id="listfun">
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                    ...
                                                    <div class="table-responsive" id="div_tabla" hidden>
                                                        <table class="table table-striped" id="table-x" >
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td><%= i++%></td>
                                                                    <td style="font-size: 10px;"><%= a.getFuncionario()%></td>
                                                                    <td style="font-size: 10px;"><%= a.getDireccion_funcionario()%></td>
                                                                    <td><%= a.getFecha()%></td>
                                                                    <td><%= a.getHora()%></td>
        ...
        <script>
            $(document).ready(function () {
                ...
                div_tabla = document.getElementById('div_tabla')
                div_cargando.hidden=true
