...
<%
    ...
    try {
        ...
        tutoriales = enlace.getTutoriales();
    } catch (Exception e) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Manuales</title>
                                                    ...
                                                    <tbody>
                                                        <%
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="width: 75%">
                                                                    <font size="3"><%=t.getDescripcion()%></font>
                                                                </td>
                                                                <td style="width: 10%">
                                                                    <a target="_blank" href="<%=t.getVideo()%>">
                                                                        <img src="assets/img/yt.png" style="width: 30px; height: 30px;">
                                                                    </a>
                                                                </td>
                                                                <td style="width: 10%">
                                                                    <a target="_blank" href="descargar_archivo.control?accion=descargar_archivo&ruta=<%=t.getPdf()%>" class="btn"><i class="fas fa-download" data-toggle="tooltip" data-original-title="Descargar"></i></a>
                                                                </td>
                                                            </tr>
                                                        <%i++;}%>
                                                    </tbody>
