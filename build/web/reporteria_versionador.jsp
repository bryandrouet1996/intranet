...
<%
    ...
    try {
        ...
        versiones = request.getParameter("txtini") == null ? (tecnico == -1 ? enlace.getVersionesRecientes() : enlace.getVersionesByUsu(tecnico)) : (tecnico == -1 ? enlace.getVersionesByFechas(fecha_inicio, fecha_fin) : enlace.getVersionesByUsuarioFechas(tecnico, fecha_inicio, fecha_fin));
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Reportería de versiones</title>
        <!-- General CSS Files -->
