...
<%
    ...
    try {
        ...
        if (!(enlace.verificarUsuarioCumpleRol(id, "administrador") || enlace.verificarUsuarioCumpleRol(id, "rol_x"))) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Descarga Excel</title>
        <!-- General CSS Files -->
    ...
    <body>
                        ...
                        <div class="section-body">        
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form id="formDescargar" action="administrar_excel.control?accion=crear" method="post" enctype="multipart/form-data" class="needs-validation">
                                                <div class="row">
                                                    <div class="form-group col-md-6" hidden="">
                                                        <input type="text" class="form-control" name="idUsu" id="idUsu" required="" readonly="" value="<%= informacion.getId_usuario()%>">
                                                    </div> 
                                                    <div class="col-3">
                                                        <label>Acción</label><br>
                                                        <button type="submit" class="btn btn-primary" id="btnGenerar"><i class="fas fa-check-circle"></i> Generar</button>
                                                        <a id="btnDescargar" hidden="" target="_blank" href="descargar_archivo.control?accion=descargar_archivo&ruta=" class="btn btn-primary btn-sm active"><i class="fas fa-check-circle"></i> Descargar</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <script type="text/javascript">
            window.onload = function () {
                $.post('administrar_excel.control?accion=eliminar', {
                    idUsu: <%= id%>
                }, function (responseText) {
                    if (responseText) {
                        console.log('Solicitud previa eliminada');
                    } else {
                        console.log('Solicitud previa inexistente o error al eliminar');
                    }
                }, ).fail(function () {
            ...
            $(document).ready(function () {
                $('#formDescargar').submit(function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response) {
                                ...
                                btnDescargar.href = btnDescargar.href + response;
                                Swal.fire({
                                    title: "Excel generado",
                                    text: "Ahora puede descargar el archivo",
                                    icon: "success",
                                ...
                                Swal.fire({
                                    ...
                                    location.href = "descargaExcel.jsp";
                                });
                            }
                        },
                        error: function () {
