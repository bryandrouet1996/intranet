...
<%
    ...
    ArrayList<convocatoria> listadoConvocatoriasVigentes = null;
    ArrayList<convocatoria> listadoConvocatoriasAnteriores = null;
    ArrayList<convocatoria> listadoConvocatoriasAnuladas = null;
    ArrayList<convocatoria> listadoConvocatoriasIncumplidas = null;
    ...
    try {
        ...
        listadoConvocatoriasVigentes = enlace.listadoConvocatoriasVigentes(informacion.getId_usuario());
        listadoConvocatoriasVigentes.addAll(enlace.listadoConvocatoriasVigentesConvocados(informacion.getId_usuario()));
        listadoConvocatoriasAnteriores = enlace.listadoConvocatoriasAnteriores(informacion.getId_usuario());
        listadoConvocatoriasAnuladas = enlace.listadoConvocatoriasAnuladas(informacion.getId_usuario());
        listadoConvocatoriasIncumplidas = enlace.listadoConvocatoriasIncumplidas(informacion.getId_usuario());
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Mis convocatorias</title>
    ...
    <body>
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Reuniones - Convocatorias</h1>
                            <div class="section-header-breadcrumb">
                                <div class="flex-column activities">
                                    <a href="registro_convocatoria.jsp" class="btn btn-primary" > <i class="far fa-calendar-plus"></i> Ingresar nueva</a>   
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Listado de convocatorias</h4>
                                        </div>
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="fas fa-check"></i> Vigentes <%if(listadoConvocatoriasVigentes.size()!=0){%><span class="badge badge-primary"><%= listadoConvocatoriasVigentes.size() %></span><%}%></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"><i class="fas fa-retweet"></i> Anteriores <%if(listadoConvocatoriasAnteriores.size()!=0){%><span class="badge badge-primary"><%= listadoConvocatoriasAnteriores.size() %></span><%}%></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="fas fa-exclamation-circle"></i> Incumplidas <%if(listadoConvocatoriasIncumplidas.size()!=0){%><span class="badge badge-primary"><%= listadoConvocatoriasIncumplidas.size() %></span><%}%></a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="anul-tab" data-toggle="tab" href="#anul" role="tab" aria-controls="anul" aria-selected="false"><i class="fas fa-ban"></i> Anuladas <%if(listadoConvocatoriasAnuladas.size()!=0){%><span class="badge badge-primary"><%= listadoConvocatoriasAnuladas.size() %></span><%}%></a>
                                                </li>
                                            </ul>
                                                ...
                                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-1">
                                                            ...
                                                            <tbody>
                                                                <%if (!listadoConvocatoriasVigentes.isEmpty()) {%>
                                                                <%for (convocatoria elem : listadoConvocatoriasVigentes) {%>
                                                                <tr>
                                                                    <td><%= elem.getFecha_convocatoria()%></td>
                                                                    <td><%= elem.getAsunto()%></td>
                                                                    <td><%= elem.getLugar()%></td>
                                                                    <td><%= elem.getHora_inicio()%></td>
                                                                    <td><%= elem.getHora_fin()%></td>
                                                                    <td>
                                                                        <a target="_blank" href="reporte_acta.control?tipo=reporte_convocatoria&iconv=<%= elem.getId_convocatoria()%>" class="btn btn-primary btn-sm"><i data-toggle="tooltip" data-original-title="Generar documento" class="fa fa-print"></i></a>
                                                                        <%if(elem.getId_convocador()==informacion.getId_usuario()){%>
                                                                            <a href="javascript:" type="button" onclick="editarConvocatoria(<%= elem.getId_convocatoria()%>)" class="btn btn-primary btn-sm"><i data-toggle="tooltip" data-original-title="Editar" class="fas fa-edit"></i></a>
                                                                        <%}
                                                                        %>
                                                                        <a href="javascript:" data-toggle="modal" data-target="#modalAnularConvocatoria" data-idconv="<%= elem.getId_convocatoria() %>" class="btn btn-primary btn-sm"><i data-toggle="tooltip" data-original-title="Anular" class="fas fa-ban"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                                <%}%>
                                                ...
                                                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-2">
                                                            ...
                                                            <tbody>
                                                                <%if (!listadoConvocatoriasAnteriores.isEmpty()) {%>
                                                                <%for (convocatoria elem : listadoConvocatoriasAnteriores) {%>
                                                                <tr>
                                                                    <td><%= elem.getFecha_convocatoria()%></td>
                                                                    <td><%= elem.getAsunto()%></td>
                                                                    <td><%= elem.getLugar()%></td>
                                                ...
                                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-3">
                                                            ...
                                                            <tbody>
                                                                <%if (!listadoConvocatoriasIncumplidas.isEmpty()) {%>
                                                                <%for (convocatoria elem : listadoConvocatoriasIncumplidas) {%>
                                                                <tr>
                                                                    <td><%= elem.getFecha_convocatoria()%></td>
                                                                    <td><%= elem.getAsunto()%></td>
                                                                    <td><%= elem.getLugar()%></td>
                                                                    ...
                                                                    <td><%= elem.getHora_fin()%></td>
                                                                    <td>
                                                                        <a class="btn btn-primary" data-toggle="modal" data-target="#modalDetalle"></a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                                <%}%>
                                                ...
                                                <div class="tab-pane fade" id="anul" role="tabpanel" aria-labelledby="anul-tab">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-4">
                                                            ...
                                                            <tbody>
                                                                <%if (!listadoConvocatoriasAnuladas.isEmpty()) {%>
                                                                <%for (convocatoria elem : listadoConvocatoriasAnuladas) {%>
                                                                <tr>
                                                                    <td><%= elem.getFecha_convocatoria()%></td>
                                                                    <td><%= elem.getAsunto()%></td>
                                                                    <td><%= elem.getLugar()%></td>
                                                                    ...
                                                                    <td><%= elem.getHora_fin()%></td>
                                                                    <td>
                                                                        <a href="javascript:" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalDetalle"><i class="fa fa-eye" data-toggle="tooltip" data-original-title="Ver detalles"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                                <%}%>
                ...
                <div class="modal fade" id="modalAnularConvocatoria" tabindex="-1" role="dialog" aria-hidden="true">
                                ...
                                <form class="needs-validation">
                                    <div class="form-row">
                                        <div class="form-group col-md-12" hidden="">
                                            ...
                                            <input type="text" class="form-control" name="txtidconvocatoria" id="txtidconvocatoria" required="">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label>Razón</label>
                                            <textarea type="text" class="form-control" name="txtrazon" id="txtrazon" required="" placeholder="Escriba aqui la razón por la que se anula la convocatoria"></textarea>
                                            <div class="invalid-feedback">
                                                Escriba la razón por la que se anula 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button onclick="anularConvocatoria()" type="button" class="btn btn-primary">Registrar</button>
