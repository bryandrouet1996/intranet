...
<%
    ...
    try {
        ...
        listadoRegistrados = enlace.listadoViaticosUsuarioAutoridadEstado(informacion.getId_usuario(), 1);
        listadoRevisados = enlace.listadoViaticosUsuarioAutoridadEstado(informacion.getId_usuario(), 2);
        listadoAprobados = enlace.listadoViaticosUsuarioAutoridadEstado(informacion.getId_usuario(), 3);
        listadoRechazados = enlace.listadoViaticosUsuarioAutoridadEstado(informacion.getId_usuario(), 4);
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Aprobación de viáticos</title>
    ...
    <body>
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a type="button" href="javascript:" data-toggle="modal" data-target="#modalRegistroAprobacion" data-id="<%= elem.getId_viatico() %>" class="btn btn-primary btn-sm active"><i class="fa fa-check-double" data-toggle="tooltip" data-original-title="Aprobar"></i></a>
                ...
                <div class="modal fade" id="modalRegistroAprobacion" role="dialog">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-body">
                                <p class="small"></p>
                                <form id="formRegistroAprobacion" action="administrar_viatico.control?accion=aprobar_viatico" method="post" enctype="multipart/form-data" class="needs-validation">
                                    <div class="form-row">
                                        <div class="form-group col-md-6" hidden="">
                                            <label>id viatico</label>
                                            <input type="text" class="form-control" name="idmra" id="idmra" required="" readonly="">
                                        </div>
                                        <div class="form-group col-md-6" hidden="">
                                            <label>id usu</label>
                                            <input type="text" class="form-control" name="usumra" id="usumra" required="" value="<%= id %>" readonly="">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label>Motivo</label>
                                            <textarea type="text" class="form-control" placeholder="Ingrese el motivo de aprobación" name="motivomra" id="motivomra" required=""></textarea>
        ...
        <script>
            ...
            $('#modalRegistroAprobacion').on('show.bs.modal', function (event) {
                var button = $(event.relatedTarget);
                var id = button.data('id');
                var modal = $(this);
                modal.find('.modal-body #idmra').val(id);
            })
            ...
            $(document).ready(function () {
                $('#formRegistroAprobacion').submit(function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            if (response) {
                                $('#modalRegistroAprobacion').modal('hide');
                                swal("Viático aprobado", "El viático fue aprobado", {
                                    icon: "success",
                                    buttons: {
                                        confirm: {
                                    ...
                                    location.href = "aprobacion_viaticos.jsp";
                                });
                            } else {
                                swal("Error al aprobar", "El viático no fue aprobado", {
                                    icon: "warning",
                                    buttons: {
                                        confirm: {
