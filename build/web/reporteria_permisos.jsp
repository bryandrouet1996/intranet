...
<%
    ...
    try {
        ...
        if (!(enlace.verificarUsuarioCumpleRol(id, "administrador") || enlace.verificarUsuarioCumpleRol(id, "encargado_permisos")  || enlace.verificarUsuarioCumpleRol(id, "encargado_iess"))) {
        ...
        listadoAuditoria = request.getParameter("txtini") == null ? (tecnico == -1 ? oracle.getPermisos() : oracle.getPermisos(tecnico)) : (tecnico == -1 ? oracle.getPermisos(fecha_inicio, fecha_fin) : oracle.getPermisos(tecnico, fecha_inicio, fecha_fin));
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Reportería de permisos</title>
        <!-- General CSS Files -->
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Reportería de permisos aprobados</h1>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="fas fa-history"></i> Registros <%=fecha_inicio == null && fecha_fin == null ? "recientes" : "consultados"%> <%if (listadoAuditoria.size() != 0) {%><span class="badge badge-primary"><%= listadoAuditoria.size()%></span><%}%></a>
                                                </li>
                                            </ul>
