...
<%
    ...
    try {
        id = Integer.parseInt(sesion.getAttribute("usuario_fu").toString());
    ...
    <body>
                ...
                <div class="main-sidebar sidebar-style-2">
                    <aside id="sidebar-wrapper">
                        <div class="sidebar-brand">
                            <a href="principal_fun.jsp">
                                <img src="assets/img/aaa.png" height="50px">
                            </a>
                        </div>
                        <div class="sidebar-brand sidebar-brand-sm">
                            <a href="principal_fun.jsp">DS</a>
                        </div>
                        <ul class="sidebar-menu">
                            <li class="dropdown active">
                                <a href="principal_fun.jsp" class="nav-link"><i class="fas fa-home"></i><span>Principal</span></a>
                            </li>
                ...
                <div class="modal fade" id="modalInicio" role="dialog">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <img src="assets/img/insti.jpg" class="img-fluid"/>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <a target="_blank" href="https://share.hsforms.com/1FGapwhhLSuWTCoKfj87C1gchcv7" type="button">Click aquí para obtener más información</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <script>
            ...
            height: 'auto',
                    ...
                    events: [
            <% for (int paso = 0; paso < listadoEventosUsuario.size(); paso++) {
                    int id_usuarioEvento = listadoEventosUsuario.get(paso).getId_usuario();
            ...
            %>
                    {
                    id: "<%= listadoEventosUsuario.get(paso).getId_evento()%>",
                            title: "<%= listadoEventosUsuario.get(paso).getTitulo()%>",
                            start: "<%= listadoEventosUsuario.get(paso).getInicio()%>",
                            end: "<%= listadoEventosUsuario.get(paso).getFin()%>",
                            color: "<%= listadoEventosUsuario.get(paso).getColor()%>",
                            starthora: "<%= listadoEventosUsuario.get(paso).getHora_inicio()%>",
                            endhora: "<%= listadoEventosUsuario.get(paso).getHora_fin()%>",
                            estado: "<%= listadoEventosUsuario.get(paso).getId_estado()%>",
