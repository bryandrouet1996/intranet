...
<%
    ...
    try {
        ...
        encuesta = enlace.verificarUsuarioEncuesta(id);
    } catch (Exception e) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Encuestas</title>
        <!-- General CSS Files -->
    ...
    <body>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Encuesta de agosto de 2022</h4>
                                        </div>
                                        <div class="card-body">                                            
                                            <p>Haga clic en el siguiente botón para completar la encuesta:</p>
                                            <% if(enlace.verificarUsuarioEncuesta(id)){%>
                                                <a class="active badge badge-primary btn btn-primary" onclick="alertarYa()"> Encuesta de satisfacción</a>
                                            <%}else{%>
                                                <a href="<%=enlace.getEncuestaAbierta()%>" target="_blank" class="active badge badge-primary btn btn-primary" onclick="abrirEncuesta()"> Encuesta de satisfacción</a>
                                            <%}%>
        ...
        <script type="text/javascript">
            window.onload = function () {
                if (!<%=encuesta%>) {
                    iziToast.warning({
                        ...
                        message: 'Por favor complete la encuesta para poder continuar',
                        position: 'topRight',
                    });
                }
            }
            ...
            function abrirEncuesta(){
                ...
                $.post('administrar_encuesta.control?accion=abrir_encuesta', {
                    id_usu: <%=id%>
                    ...
                    if (responseText) {
                        ...
                        Swal.fire({
                            title: "Error",
                            text: "No se pudo abrir la encuesta",
                            icon: "error",
