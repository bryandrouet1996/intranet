...
<%
    ...
    try {
        ...
        if(request.getParameter("iu") != null){
            id_fun = Integer.parseInt(request.getParameter("iu"));
            info = enlace.buscar_usuarioID(id_fun);
        }
        ...
        if (request.getParameter("fecha_inicio") != null && request.getParameter("fecha_fin") != null) {
            ...
            listadoTodasActividades = enlace.listadoActividadesTodasRangoFechaUsuarioId(id_fun, fecha_inicio, fecha_fin);
            listadoActividadesVinculantes = enlace.listadoActividadesTodasRangoFechaRequirenteID(info.getApellido()+" "+info.getNombre(), fecha_inicio, fecha_fin);
        }else{
            listadoTodasActividades = enlace.listadoTodasActividades(id_fun);
            listadoActividadesVinculantes = enlace.listadoTodasActividadesRequirenteNombre(info.getApellido()+" "+info.getNombre());
        }
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Detalle de actividades funcionario</title>
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Control general de actividades | <%= info.getApellido() %> <%= info.getNombre() %></h1>
                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link  active" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"><i class="fas fa-bars"></i> Registradas</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false"><i class="fas fa-exchange-alt"></i> Vinculantes</a>
                                                </li>
                                            </ul>
                                                        ...
                                                        <table class="table table-striped" id="table-1">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="javascript:" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalVer" data-fecha="<%= todas.getFecha_actividad() %>" data-tarea="<%= todas.getTarea() %>" data-horai="<%= todas.getHora_inicio() %>" data-horaf="<%= todas.getHora_fin() %>" data-requirente="<%= todas.getRequiriente() %>" data-avance="<%= todas.getAvance() %>" data-herramienta="<%= todas.getHerramienta() %><%= todas.getHerramienta_otro() %>" data-observacion="<%= todas.getObservacion() %>"><i class="fas fa-eye" data-toggle="tooltip" data-original-title="Ver más"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
                                                        ...
                                                        <table class="table table-striped" id="table-2">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><%= vinc.getTarea()%></td>
                                                                    <td>
                                                                        <a href="javascript:" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalVer" data-fecha="<%= vinc.getFecha_actividad() %>" data-tarea="<%= vinc.getTarea() %>" data-horai="<%= vinc.getHora_inicio() %>" data-horaf="<%= vinc.getHora_fin() %>" data-requirente="<%= vinc.getRequiriente() %>" data-avance="<%= vinc.getAvance() %>" data-herramienta="<%= vinc.getHerramienta() %><%= vinc.getHerramienta_otro() %>" data-observacion="<%= vinc.getObservacion() %>"><i class="fas fa-eye" data-toggle="tooltip" data-original-title="Ver más"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
