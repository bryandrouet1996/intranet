        ...
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <%
                        ArrayList<actividad> listadoActividadesRegistradas = enlace.listadoActividadesRegistradasUnidad(informacion.getCodigo_unidad());
                    %>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="table-1">
                                                    ...
                                                    <tbody>
                                                        <%
                                                            for (int paso = 0; paso < listadoActividadesRegistradas.size(); paso++) {
                                                                int id_actividad = listadoActividadesRegistradas.get(paso).getId_actividad();
                                                                String tiempo_ejecucion = enlace.tiempoEjecucionTarea(id_actividad);
                                                                int id_usuario = listadoActividadesRegistradas.get(paso).getId_usuario();
                                                                usuario elemento = enlace.buscar_usuarioID(id_usuario);
                                                                String nombre_completo = elemento.getApellido() + " " + elemento.getNombre();
                                                        %>
                                                        <%if(id_usuario!=informacion.getId_usuario()){%>
                                                        <tr>
                                                            <td><%= listadoActividadesRegistradas.get(paso).getFecha_actividad()%></td>
                                                            <td><%= nombre_completo%></td>
                                                            <td><%= tiempo_ejecucion%></td>
                                                            <td><%= listadoActividadesRegistradas.get(paso).getTarea()%></td>
                                                            <td>
                                                                <a data-toggle="modal" data-target="#modalDetalle" class="btn btn-primary btn-sm active" data-fecha="<%= listadoActividadesRegistradas.get(paso).getFecha_actividad()%>" data-tarea="<%= listadoActividadesRegistradas.get(paso).getTarea()%>" data-horai="<%= listadoActividadesRegistradas.get(paso).getHora_inicio()%>" data-horaf="<%= listadoActividadesRegistradas.get(paso).getHora_fin()%>" data-requirente="<%= listadoActividadesRegistradas.get(paso).getRequiriente()%>" data-avance="<%= listadoActividadesRegistradas.get(paso).getAvance()%>" data-herramienta="<%= listadoActividadesRegistradas.get(paso).getHerramienta()%>" data-observacion="<%= listadoActividadesRegistradas.get(paso).getObservacion()%>"><i class="fas fa-eye" data-toggle="tooltip" data-original-title="Ver informacion"></i></a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <%}%>
