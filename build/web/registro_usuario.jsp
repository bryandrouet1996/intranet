                ...
                <div class="main-content">
                    ...
                    <section class="section">
                        <div class="section-header">
                            <h1>Creación de cuenta de usuario</h1>
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="form-group col-md-4">
                                                    <label>Cédula</label>
                                                    <input type="text" class="form-control" placeholder="Cédula funcionario" name="txtcedula" id="txtcedula" onblur="ValidarCedula('txtcedula')" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Nombre</label>
                                                    <input type="text" class="form-control" placeholder="Nombre funcionario" name="txtnombre" id="txtnombre" required>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label>Apellidos</label>
                                                    <input type="text" class="form-control" placeholder="Apellido funcionario" name="txtapellido" id="txtapellido" required>
                                                </div>
                                                <div class="form-group col-md-5">
                                                    <label>Correo electrónico</label>
                                                    <input type="text" class="form-control" placeholder="Correo funcionario" name="txtcorreo" id="txtcorreo" required>
                                                </div>
                                                ...
                                                <div class="form-group col-md-2">
                                                    ...
                                                    <input readonly="" type="text" class="form-control datepicker" name="txtfechanacimiento" id="txtfechanacimiento" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer text-center">
                                            <button class="btn btn-primary" onclick="crearUsuario()">Registrar cuenta</button> 
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            function ValidarCedula(campo) {
                ...
                if (ced !== "" && longitud === 10) {
                    ...
                    if (!(parseInt(ced.charAt(longitud - 1)) === total)) {
                        ...
                        $.post('sesion.control?accion=consultar_datos', {
                            iu: <%=informacion.getId_usuario()%>,
                            txtcedula: ced
                        }, function (responseText) {
                            var res = responseText.split('*');
                            if (responseText) {
                                document.getElementById('txtapellido').value = res[0];
                                document.getElementById('txtnombre').value = res[1];
                                document.getElementById('txtfechanacimiento').value = res[2];
                            } else {
                                swal("Datos del usuario", "No se pudieron consultar los datos del usuario, intente más tarde", {
                                    icon: "error",
                                    buttons: {
                                        confirm: {
                                            className: 'btn btn-danger'
