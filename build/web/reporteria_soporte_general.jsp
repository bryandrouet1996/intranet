...
<%
    ...
    int numEstado = -1;
    int tecnico = -1;
    int nuevos=0,asignados=0, atendiendo=0, atendidos=0,devueltos=0;
    try {
        ...
        listadoSoportesSolicitados = request.getParameter("txtini") == null ? (numEstado == -1 ? (tecnico == -1 ? enlace.listadoSolicitudesRecienteMes() : enlace.listadoSolicitudesUsuarioRecienteMes(tecnico)) : (tecnico == -1 ? enlace.listadoSolicitudesRecienteMes(numEstado) : enlace.listadoSolicitudesUsuarioEstadoRecienteMes(tecnico, numEstado))) : (numEstado == -1 ? (tecnico == -1 ? enlace.listadoSolicitudesFecha(fecha_inicio, fecha_fin) : enlace.listadoSolicitudesUsuarioFecha(tecnico, fecha_inicio, fecha_fin)) : (tecnico == -1 ? enlace.listadoSolicitudesFechaEstado(fecha_inicio, fecha_fin, numEstado) : enlace.listadoSolicitudesUsuarioFechaEstado(tecnico, fecha_inicio, fecha_fin, numEstado)));
        for (solicitud_soporte s : listadoSoportesSolicitados) {
            switch(s.getEstado()){
                case 0:
                    nuevos++;
                    break;
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Reportería de soportes - General</title>
        <!-- General CSS Files -->
    ...
    <body>
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Reportería de soportes - General</h1>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-2">
                                                        ...
                                                        <select class="form-control select2" name="txtestado" id="txtestado">
                                                            ...
                                                            <option <%=numEstado==5?"selected":""%> value="5">Devueltos</option>
                                                        </select>
                                                    </div>
                                                    <div class="col-3">
                                                        <label>Técnico</label>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="fas fa-users"></i> Soportes <%=fecha_inicio == null && fecha_fin == null ? "recientes" : "consultados"%> <%if (listadoSoportesSolicitados.size() != 0) {%><span class="badge badge-primary"><%= listadoSoportesSolicitados.size()%></span><%}%></a>
                                                </li>
                                            </ul>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <%} else if(soli.getEstado()==5) {%>
                                                                            <a type="button" class="btn btn-primary btn-sm active"><i class="fa fa-eye" data-toggle="tooltip" data-original-title="Ver detalles"></i></a>
                                                                            <a type="button" href="javascript:" data-toggle="modal" data-target="#modalAsignacion" data-codigo="<%= soli.getId_solicitud() %>" class="btn btn-primary btn-sm active"><i class="fas fa-user-tag" data-toggle="tooltip" data-original-title="Asignar"></i></a>
                                                                        <%}else if(soli.getEstado()==1) {%>
        ...
        <script>
            ...
            new Chart(document.getElementById("canvas-x"), {
                type: 'bar',
                data: {
                  labels: ["Nuevos", "Devueltos", "Asignados", "Atendiendo", "Atendidos"],
                  datasets: [
                    {
                      label: "Soportes",
                      backgroundColor: ["#FFF26D", "#FF6F6F","#FFB937","#6FCDF8","#B9FF7F"],
                      data: [<%=nuevos%>,<%=devueltos%>,<%=asignados%>,<%=atendiendo%>,<%=atendidos%>]
                    }
                  ]
                },
                options: {
