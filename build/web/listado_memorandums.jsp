...
<%
    ...
    try {
        ...
        listadoPorCaducar = enlace.ObtenerMemorandumsPorCaducarUsuarioID(informacion.getId_usuario());
        listadoPendientes = enlace.ObtenerListadoMemorandumsUsuarioIDEstado(informacion.getId_usuario(), StatusEnum.PENDIENTE.getParam());
        listadoCompletados = enlace.ObtenerListadoMemorandumsUsuarioIDEstado(informacion.getId_usuario(), StatusEnum.COMPLETADO.getParam());
    } catch (Exception e) {
...
<html lang="es">
    ...
    <body>
        <div id="app">
                        ...
                        <div class="section-header">
                            ...
                            <div class="section-header-breadcrumb">
                                <div class="flex-column activities">
                                    <a href="javascript:" data-toggle="modal" data-target="#modalConfiguracionAlerta" class="btn btn-primary" > <i class="fas fa-sync"></i> Configurar alertas</a>   
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="alert alert-warning alert-has-icon">
                                                ...
                                                <div class="alert-body">
                                                    Estimado funcionario posee memorandums que estan a punto de cumplir su fecha límite, se detalla el número documento y los dias que le quedan:
                                                    <ul>
                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="pendientes-tab" data-toggle="tab" href="#pendientes" role="tab" aria-controls="pendientes" aria-selected="true"><i class="fas fa-arrow-circle-down"></i> Bandeja de entrada</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="completados-tab" data-toggle="tab" href="#completados" role="tab" aria-controls="completados" aria-selected="false"><i class="fas fa-arrow-circle-up"></i> Bandeja de salida</a>
                                                </li>
                                            </ul>
                                                        ...
                                                        <table class="table table-striped" id="table-x">
                                                            ...
                                                            <tbody>
                                                                <%for (Memorandum memorandum : listadoPendientes) {
                                                                        System.out.println(memorandum.getDias_restantes());
                                                                        usuario usuarioAsignador = enlace.buscar_usuarioID(memorandum.getId_usuario());
                                                                %>
                                                                <tr>
                                                                    <td><%= memorandum.getActividad()%></td>
                                                        ...
                                                        <table class="table table-striped" id="table-xx">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><%= memorandum.getObservacion_final()%></td>
            ...
            <div class="modal fade" id="modalConfiguracionAlerta" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                        <div class="modal-header bg-primary">
                            <h5 class="modal-title white">
                                <span class="fw-extrabold">
                                    <i class="bi bi-alarm"></i> Configurar alerta
                                </span>
                            </h5>
                        ...
                        <div class="modal-body">
                            <p class="small"></p>
                            <form  id="formConfigurarAlerta" action="alerta.ct?opcion=registro" method="post" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="form-group col-md-12" hidden="">
                                        <label>Id usuario</label>
                                        <input type="text" class="form-control" placeholder="Ingrese nueva contraseña" name="txtidusuario" id="txtidusuario" required="" value="<%= informacion.getId_usuario()%>">
                                        <div class="invalid-feedback">
                                            No ha ingresado ninguna información
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Dias de anticipación</label>
                                        <select class="form-control" name="comboalerta" id="comboalerta" required="">
                                            <option value="<%= alertaInfo.getDias_notificacion()%>"><%= alertaInfo.getDias_notificacion()%></option>
                                ...
                                <div class="alert alert-info">
                                    <b>NOTA:</b> Al configurar la alerta se le notificaran los memorandums que se encuentren entre ese lapso configurado.
                                </div>
        ...
        <script src="fun_js/MemorandumJS.js" type="text/javascript"></script>
        <script src="fun_js/AlertaJS.js" type="text/javascript"></script>
