...
<%@page import="modelo.AuditoriaDINARDAP"%>
...
<%
    ...
    ArrayList<AuditoriaDINARDAP> listadoAuditoria = null;
    ...
    try {
        ...
        listadoTecnicos = enlace.listarUsuariosDINARDAP();
        ...
        listadoAuditoria = request.getParameter("txtini") == null ? (tecnico == -1 ? enlace.listarAuditoriaDINARDAP() : enlace.listarAuditoriaDINARDAPUsuario(tecnico)) : (tecnico == -1 ? enlace.listarAuditoriaDINARDAPFecha(fecha_inicio, fecha_fin) : enlace.listarAuditoriaDINARDAPUsuarioFecha(tecnico, fecha_inicio, fecha_fin));
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Reportería SINARP</title>
        <!-- General CSS Files -->
                                                        ...
                                                        <table class="table table-striped" id="table-x">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="width: 20%">Dato consultado</th>
                                                                    <th style="width: 30%">Tipo de consulta</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <%for (AuditoriaDINARDAP audit : listadoAuditoria) {
                                                                        usuario func = enlace.buscar_usuarioID(audit.getIdUsu());
                                                                %>
                                                                <tr>
                                                                    <td><%= audit.getId()%></td>
                                                                    <td><%= audit.getFecha()%></td>
                                                                    <td><%= func.getApellido()%> <%= func.getNombre()%></td>
                                                                    <td><%= audit.getIp()%></td>
                                                                    <td><%= audit.getDato()%></td>
                                                                    <td><%= enlace.getDescripcionCategoriaDINARDAP(audit.getCategoria())%></td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
                                                        </table>
