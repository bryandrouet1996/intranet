...
<%@page import="dinardap.Titulo"%>
<%@page import="dinardap.Columna"%>
<%@page import="dinardap.Fila"%>
<%@page import="dinardap.DINARDAP"%>
<%@page import="dinardap.Entidad"%>
...
<%
    ...
    try {
        ...
        if (sesion.getAttribute("hash") != null) {
            hash = sesion.getAttribute("hash").toString();
            sesion.removeAttribute("hash");
        }
    } catch (Exception e) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Hash</title>
        <!-- General CSS Files -->
    ...
    <body>
                ...
                <div class="main-content">
                    ...
                    <section class="section">
                        <div class="section-header">
                            <h1>Etiqueta de seguridad: SHA-512</h1>
                        </div>
                        <div class="section-body">        
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form id="formHash" action="administrar_hash.control?accion=hash" method="post" enctype="multipart/form-data" class="needs-validation" novalidate="">
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-5">
                                                        <label>Archivo (tamaño máximo 500 MB)</label>
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <button type="submit" class="btn btn-primary"><i class="fas fa-check-circle"></i> Generar</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label>SHA-512</label>
                                                    <textarea disabled="" type="text" class="form-control" placeholder="Hash" name="txthash" id="txthash"><%= hash%></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script type="text/javascript">
            function validateSize() {
                ...
                if (fileSize > 500) {
                    swal("Mensaje", "El archivo excede el tamaño máximo de 500 MB", {
                        icon: "warning",
                        buttons: {
                            confirm: {
