...
<%
    ...
    ArrayList<Documento> listadoEnviado = null;
    ...
    try {
        ...
        listadoEnviado = request.getParameter("txtini") == null ? mysql.getDocumentosEnviados(informacion.getId_usuario(), 2) : mysql.getDocumentosEnviados(informacion.getId_usuario(), 2, fecha_inicio, fecha_fin);
    } catch (Exception e) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Documentos enviados</title>
        <!-- General CSS Files -->
                    ...
                    <aside id="sidebar-wrapper">
                        ...
                        <ul class="sidebar-menu">
                            ...
                            <li class="menu-header">COMPONENTES</li>
                                ...
                                %>
                            <li class="<%= c.getRuta_enlace().equals("mis_documentos") ? "active" : ""%>"><a class="nav-link" href="sesion.control?accion=<%= c.getRuta_enlace()%>&iu=<%= id%>"><i class="<%= c.getIcono()%>"></i> <span><%= c.getDescripcion()%></span></a></li>
                                <%}%>
                        </ul>
                    </aside>
                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true"><i class="fas fa-paper-plane"></i> Enviados <%if (listadoEnviado.size() != 0) {%><span class="badge badge-primary"><%= listadoEnviado.size()%></span><%}%></a>
                                                </li>
                                            </ul>
                                                ...
                                                <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-x">
                                                            ...
                                                            <tbody>
                                                                <%for (Documento d : listadoEnviado) {%>
                                                                <tr>
                                                                    <td>
                                                                        <%if (d.isFirmado()) {%>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a onclick="abrir_modal_anexos(<%= d.getId()%>)" type="button" data-toggle="modal" class="btn btn-primary btn-sm active"><i class="fa fa-folder-open" data-toggle="tooltip" data-original-title="Ver anexos"></i></a>
                                                                            <%}%>
                                                                        <a href="administrar_documento.control?accion=ver_mi_hoja_ruta&id_documento=<%= d.getId()%>" target="_blank" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Ver hoja de ruta"><i class="fas fa-print"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                            </tbody>
