...
<%
    ...
    try {
        ...
        if (!(enlace.verificarUsuarioCumpleRol(id, "administrador") || enlace.verificarUsuarioCumpleRol(id, "aprueba_gastos") || enlace.verificarUsuarioCumpleRol(id, "valida_gastos"))) {
...
<html lang="en">
    <head>
        ...
        <title>Intranet Alcaldía - Administración de gastos personales</title>
        <!-- General CSS Files -->
    ...
    <body>
        <div id="app">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%">
                                                            ...
                                                            <%if (enlace.verificarUsuarioCumpleRol(id, "administrador") || enlace.verificarUsuarioCumpleRol(id, "aprueba_gastos")) {%>
                                                            <a type="button" onclick="aprobarFormulario(<%= g.getId()%>)" class="btn btn-primary btn-sm active"><i class="fas fa-check" data-toggle="tooltip" data-original-title="Aprobar"></i></a>
                                                            <%}%>
                                                            <a href="javascript:" type="button" data-toggle="modal" data-target="#modalRechazar" data-id="<%= g.getId()%>" class="btn btn-primary btn-sm active"><i class="fa fa-times" data-toggle="tooltip" data-original-title="Rechazar"></i></a>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%">
                                                            ...
                                                            <%if (enlace.verificarUsuarioCumpleRol(id, "administrador") || enlace.verificarUsuarioCumpleRol(id, "valida_gastos")) {%>
                                                            <a type="button" onclick="validarFormulario(<%= g.getId()%>)" class="btn btn-primary btn-sm active"><i class="fas fa-check" data-toggle="tooltip" data-original-title="Validar"></i></a>
                                                            <%}%>
                                                            <a href="javascript:" type="button" data-toggle="modal" data-target="#modalRechazar" data-id="<%= g.getId()%>" class="btn btn-primary btn-sm active"><i class="fa fa-times" data-toggle="tooltip" data-original-title="Rechazar"></i></a>
                                                            <a target="_blank" href="administrar_gastos.control?accion=generar_excel&id_gasto=<%= g.getId()%>" class="btn btn-primary btn-sm"><i data-toggle="tooltip" data-original-title="Generar documento" class="fa fa-print"></i></a>
                                                        </td>
                            ...
                            <form id="formRegistro" action="administrar_gastos.control?accion=registro_formulario" method="post" enctype="multipart/form-data" class="needs-validation">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label>Total de ingresos con este empleador</label>
                                        <input type="number" step="0.01" class="form-control" placeholder="Ingrese el valor" name="c103" id="c103" required onchange="calcular105()">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="c105" id="c105" readonly required>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <span style="font-weight: bold">
            ...
            <div class="modal fade"  role="dialog" aria-hidden="true" id="modalRechazar">
                <div class="modal-dialog modal-lg" role="dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-center">
                        ...
                        <div class="modal-body">
                            <form id="formRechazar" action="administrar_gastos.control?accion=rechazar" method="post" enctype="multipart/form-data" class="needs-validation">
                                <div class="form-row">
                                    <input id="id" name="id" hidden>
                                    <div class="form-group col-md-12">
                                        <label>Razón de rechazo</label>
                                        <textarea type="text" class="form-control" placeholder="Describa brevemente el motivo de rechazo" id="motivo" name="motivo" required></textarea>
                                        <div class="invalid-feedback">
                                            No se ha detallado el motivo
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" id="btnRechazar" class="btn btn-primary">Rechazar</button>
                                    <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                </div>
                            </form>
                        </div>
    ...
    <script type="text/javascript">
                    ...
                    success: function (responseText) {
                        ...
                        if (response === 1) {
                            Swal.fire({
                                ...
                                location.href = "gastos_personales_admin.jsp";
                            });
                        } else if(response === 0) {
                            Swal.fire({
        ...
        $(document).ready(function () {
            $('#formRechazar').submit(function (event) {
                var btn = document.getElementById("btnRechazar");
                btn.hidden = true;
                event.preventDefault();
                $.ajax({
                    url: $(this).attr('action'),
                    ...
                    success: function (responseText) {
                        ...
                        if (response === 1) {
                            ...
                            Swal.fire({
                                ...
                                text: 'Sólo se pueden rechazar formularios pendientes o aprobados',
                                icon: 'error',
                                buttonsStyling: false,
                                customClass: {
                                    confirmButton: 'btn btn-success'
                    ...
                    error: function () {
                        Swal.fire({
                            title: 'Error crítico',
                            text: 'No se pudo completar el rechazo',
                            icon: 'error',
                            buttonsStyling: false,
                            customClass: {
                                confirmButton: 'btn btn-success'
        ...
        function calcular105(){
            var inputC103 = document.getElementById('c103'), inputC104 = document.getElementById('c104'), inputC105 = document.getElementById('c105');
        ...
        function cambioC104(){
            var input = document.getElementById('c104'), totalOtros = parseFloat(input.value);
            var divadj = document.getElementById('divadj'), adjunto = document.getElementById('adjunto');
        ...
        function calcularC113(){
            var C105 = document.getElementById('c105').value, C112 = document.getElementById('c112').value, L = C112 < CB7 ? C112 : CB7;
            var r, inputC113 = document.getElementById('c113');
        ...
        function calcular112(){
            var btn = document.getElementById("btnGuardar");
            btn.hidden = true;
            var inputC106 = document.getElementById('c106'), inputC107 = document.getElementById('c107'), inputC108 = document.getElementById('c108'), inputC109 = document.getElementById('c109'), inputC110 = document.getElementById('c110'), inputC111 = document.getElementById('c111'), inputC112 = document.getElementById('c112');
        ...
        function aprobarFormulario(id) {
            Swal.fire({
                title: '¿Desea aprobar este formulario?',
                icon: 'warning',
                buttonsStyling: false,
                ...
                if (willDelete.isConfirmed) {
                    ...
                    $.post('administrar_gastos.control?accion=aprobar', {
                        id_gasto: id
                        ...
                        if (response === 1) {
                            ...
                            Swal.fire({
                                title: "Formulario inválido",
                                text: "Sólo se pueden aprobar formularios pendientes",
                                icon: "warning",
                                buttonsStyling: false,
                                customClass: {
                                    confirmButton: 'btn btn-success'
                        ...
                        Swal.fire({
                            title: "Error crítico",
                            text: "No se aprobó el formulario",
                            icon: "error",
                            buttonsStyling: false,
                            customClass: {
                                confirmButton: 'btn btn-success'
        ...
        function validarFormulario(id) {
            Swal.fire({
                title: '¿Desea validar este formulario?',
                icon: 'warning',
                buttonsStyling: false,
                showCancelButton: true,
                confirmButtonText: 'Sí',
                ...
                if (willDelete.isConfirmed) {
                    ...
                    $.post('administrar_gastos.control?accion=validar', {
                        id_gasto: id
                    }, function (responseText) {
                        var response = parseInt(responseText);
                        if (response === 1) {
                            ...
                            Swal.fire({
                                title: "Formulario inválido",
                                text: "Sólo se pueden validar formularios aprobados",
                                icon: "warning",
                                buttonsStyling: false,
                                customClass: {
                                    confirmButton: 'btn btn-success'
                        ...
                        Swal.fire({
                            title: "Error crítico",
                            text: "No se validó el formulario",
                            icon: "error",
                            buttonsStyling: false,
                            customClass: {
                                confirmButton: 'btn btn-success'
