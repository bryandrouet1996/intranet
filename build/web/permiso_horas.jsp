                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" onchange="seleccionMotivoPermisoHoras()" name="combomotivo" id="combomotivo" required>
                                            ...
                                            <option value="<%= busq.getId_motivo()%>" <%=busq.getId_motivo() == 1 && (infor == null || !checkPendientes || enlace.verificarPermisosVacaciones(id)) ? "disabled=" : ""%>><%= busq.getDescripcion()%></option>
                                            <%}
                                                }%>
                                        </select>
                                    </div>
