...
<%
    ...
    ArrayList<convocatoria> listadoConvocatorias = null;
    ...
    try {
        ...
        listadoConvocatorias = enlace.listadoConvocatoriasVigentes(informacion.getId_usuario());
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Mis actas</title>
    ...
    <body>
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Reuniones - Actas</h1>
                            <div class="section-header-breadcrumb">
                                <div class="flex-column activities">
                                    <a href="javascript:" class="btn btn-primary" data-toggle="modal" data-target="#modalConvocatoria"> <i class="far fa-calendar-plus"></i> Ingresar nueva</a>   
                                </div>
                            </div>
                        </div>
                                                ...
                                                <table class="table table-striped" id="table-1">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a target="_blank" class="btn btn-primary btn-sm" href="reporte_acta.control?tipo=reporte_acta&iact=<%= elem.getId_acta() %>"><i data-toggle="tooltip" data-original-title="Generar acta" class="fas fa-print"></i></a>
                                                            </td>
                                                        </tr>
                                                        <%}%>
                                                        <%}%>
                ...
                <div class="modal fade" id="modalConvocatoria" tabindex="-1" role="dialog" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="table-2">
                                        ...
                                        <tbody>
                                            <%if (!listadoConvocatorias.isEmpty()) {%>
                                            <%for (convocatoria elem : listadoConvocatorias) {%>
                                            <tr>
                                                <td><%= elem.getFecha_convocatoria()%></td>
                                                <td><%= elem.getAsunto()%></td>
                                                <td><%= elem.getLugar()%></td>
                                                ...
                                                <td><%= elem.getHora_fin()%></td>
                                                <td>
                                                    <a href="registro_acta.jsp?ic=<%= elem.getId_convocatoria() %>" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Crear acta"><i class="fas fa-plus"></i> Crear acta</a>
                                                </td>
                                            </tr>
                                            <%}%>
                                            <%}%>
