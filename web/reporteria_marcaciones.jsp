...
<%
    ...
    try {
        ...
        if (request.getParameter("fecha_inicio") != null && request.getParameter("fecha_fin") != null) {
            ...
            listadoRegistradas = enlace.listadoAsistenciaEstadoUsuarioIDRangoFecha(fecha_inicio, fecha_fin, 0);
            listadoAtrasos = enlace.listadoAsistenciaEstadoUsuarioIDRangoFecha(fecha_inicio, fecha_fin, 1);
            listadoFaltas = enlace.listadoAsistenciaEstadoUsuarioIDRangoFecha(fecha_inicio, fecha_fin, 2);
            listadoJustificadas = enlace.listadoAsistenciaEstadoUsuarioIDRangoFecha(fecha_inicio, fecha_fin, 3);
        } else {
            listadoRegistradas = enlace.listadoAsistenciaEstadoUsuarioID(0);
            listadoAtrasos = enlace.listadoAsistenciaEstadoUsuarioID(1);
            listadoFaltas = enlace.listadoAsistenciaEstadoUsuarioID(2);
            listadoJustificadas = enlace.listadoAsistenciaEstadoUsuarioID(3);
        }
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Reportería de asistencias</h1>
                        </div>                            
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <form class="row" action="administrar_marcacion.control?accion=filtrar_rep" method="post">
                                            <%if (request.getParameter("fecha_inicio") == null && request.getParameter("fecha_fin") == null) {%>
                                            <div class="col-2">
