...
<%
    ...
    ArrayList<plan_operativo> listadoPlanes = null;
    ...
    try {
        ...
        listadoPlanes = enlace.listadoPlanesOperativos(informacion.getId_usuario());
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Mis planificaciones</title>
    ...
    <body>
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Planes operativos anuales <%= enlace.direccionPerteneceUsuario(codigo_funcion)%></h1>
                            <div class="section-header-breadcrumb">
                                <div class="flex-column activities">
                                    <a href="javascript:" data-toggle="modal" data-target="#modalRegistroPlan" class="btn btn-primary" > <i class="far fa-calendar-plus"></i> Crear nuevo plan</a>   
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Listado de planes operativos</h4> <a class="btn btn-icon icon-left active" id="alertPoa"> 
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped" id="table-1">
                                                    ...
                                                    <tbody>
                                                        <%if(!listadoPlanes.isEmpty()){%>
                                                        <%for(plan_operativo plan:listadoPlanes){%>
                                                        <tr>
                                                            <td><a href="actividades_plan.jsp?ipa=<%= plan.getId_plan() %>"><%= "PL-"+plan.getId_plan() %></a></td>
                                                            <td><%= plan.getAnio() %></td>
                                                            <td><%= plan.getPresupuesto() %></td>
                                                            <td>
                                                                <%if(plan.getEstado()==0){%>
                                                                    <a class="badge badge-warning text-white">Pendiente</a>
                                                                <%}else if(plan.getEstado()==1){%>
                                                                    <a class="badge badge-success text-white">Aprobado</a>
                                                                <%}else if(plan.getEstado()==2){%>
                                                                    <a class="badge badge-danger text-white">Rechazado</a>
                                                                <%}%>
                                                            </td>
                                                            <td width="100">
                                                                <%if(plan.getEstado()==0){%>
                                                                <a href="actividades_plan.jsp?ipa=<%= plan.getId_plan() %>" class="btn btn-primary btn-sm active"><i data-toggle="tooltip" data-original-title="Ver plan" class="fa fa-eye"></i></a>
                                                                ...
                                                                <%}else if(plan.getEstado()==1){%>
                                                                <a class="btn btn-primary btn-sm active"><i data-toggle="tooltip" data-original-title="Generar documento" class="fa fa-print"></i></a>
                                                                <%}else if(plan.getEstado()==2){%>
                                                                <a class="btn btn-primary btn-sm active"><i data-toggle="tooltip" data-original-title="Ver detalles" class="fa fa-eye"></i></a>
                                                                <%}%>
                                                            </td>
                                                        </tr>
                                                        <%}%>
                ...
                <div class="modal fade" id="modalRegistroPlan" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">
                                    <span class="fw-extrabold">
                                        Nuevo plan operativo anual
                                    </span>
                                </h5>
                            ...
                            <div class="modal-body">
                                <p class="small"></p>
                                <form id="formNuevoPlan" action="administrar_plan.control?accion=registrar_plan" enctype="multipart/form-data" class="needs-validation" novalidate="" method="post" >
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="txtusuario" name="txtusuario" placeholder="Funcionario" value="<%= informacion.getApellido() %> <%= informacion.getNombre() %>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="txtusuario">Dirección/Unidad</label>
                                                <input type="text" class="form-control" id="txtdireccion" name="txtdireccion" placeholder="Funcionario" value="<%= enlace.direccionPerteneceUsuario(codigo_funcion)%>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" min="0" id="txtpresupuesto" name="txtpresupuesto" value="1" required>
                                            </div>
                                        </div>
                                    </div>
