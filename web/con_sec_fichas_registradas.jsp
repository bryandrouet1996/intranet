...
<%
    ...
    ArrayList<Ficha> listadoFichas = null;
    try {
        ...
        listadoFichas = postgres.getFichasActualizadas();
    } catch (Exception e) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Listado de fichas</title>
        <!-- General CSS Files -->
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Administración de fichas</h1>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true"><i class="fas fa-check"></i> Registradas <%if(listadoFichas.size()!=0){%><span class="badge badge-primary"><%= listadoFichas.size() %></span><%}%></a>
                                    </li>
                                </ul>
                                            ...
                                            <table class="table table-striped" id="table-x">
                                                <thead>                                 
                                                    <tr>
                                                        ...
                                                        <th style="width: 20%">N° servicios entregados</th>
                                                        <th style="width: 20%">Acciones</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <%for(Ficha f : listadoFichas){%>
                                                    <tr>
                                                        <td><%= f.getParroquia().getNombre()%></td>
                                                        <td><%= f.getSector().getNombre()%></td>
                                                        <td><%= f.getBarrio().getNombre()%></td>
                                                        <td><%= f.getServicios_entregados()%></td>
                                                        <td>
                                                            <a href="administrar_ficha.control?accion=reporte_ficha&id_ficha=<%= f.getId() %>" target="_blank" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Ver reporte"><i class="fas fa-print"></i></a>
                                                            <a href="con_sec_nueva_ficha.jsp?id_barrio=<%= f.getId_barrio() %>" target="_self" class="btn btn-primary btn-sm" data-toggle="tooltip" data-original-title="Editar"><i class="fas fa-pen"></i></a>
                                                        </td>
                                                    </tr>
                                                    <%}%>
                                                </tbody>
