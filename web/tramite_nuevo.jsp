...
<%
    ...
    try {
        ...
        if (request.getParameter("itra") != null) {
            id_tramite = Integer.parseInt(request.getParameter("itra"));
        }
...
<html lang="en">
    <head>
        ...
        <title>Intranet Alcaldía - Registro de trámite</title>
        <!-- General CSS Files -->
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h6><a href="listado_tramites.jsp">Mis trámites registrados</a> > Ingresar nuevo trámite</h6>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <%if (id_tramite == 0) {%>
                                            <form class="needs-validation" id="formNuevoTramite" action="administrar_tramite.control?accion=registrar_tramite" method="post" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        <div class="form-grouponvocatoria col-md-2" hidden>
                                                            <label>Id tramite</label>
                                                            <input type="text" class="form-control" name="txtidtra" id="txtidtra" value="0" required>
                                                        </div>
                                            ...
                                            <form class="needs-validation" id="formconvocatoria" action="administrar_tramite.control?accion=actualizar_tramite" method="post" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        <div class="form-grouponvocatoria col-md-2" hidden>
                                                            <label>Id tramite</label>
                                                            <input type="text" class="form-control" name="txtidtra" id="txtidtra" value="<%= id_tramite%>" required>
                                                        </div>
                                                        <div class="form-group col-md-2" hidden>
                                                            <label>Id envia</label>
                                                            <input type="text" class="form-control" name="txtiusu" id="txtiusu" value="<%= informacion.getId_usuario()%>" required>
