                ...
                <div class="main-content">
                    <%
                        if (ind != 0) {
                            try {
                                ...
                                int cantidad_regis = enlace.cantidadActividadesRegistradasDireccionCodigoFuncion(codigo_funcion, fecha_inicio, fecha_fin);
                                cantidad_corregidas = enlace.cantidadActividadesCorregidasDireccionCodigoFuncion(codigo_funcion, fecha_inicio, fecha_fin);
                                cantidad_aprobadas = enlace.cantidadActividadesAprobadasDireccionCodigoFuncion(codigo_funcion, fecha_inicio, fecha_fin);
                                cantidad_registradas=cantidad_regis-cantidad_corregidas;
                                float cantidad_total = enlace.cantidadActividadesDireccionCodigoFuncion(codigo_funcion, fecha_inicio, fecha_fin);
                                ...
                                listadoResumen = enlace.resumenActividadesDireccionRangoFecha(codigo_funcion, fecha_inicio, fecha_fin);
                                listadoResumenAprobadas = enlace.resumenActividadesAprobadasDireccionRangoFecha(codigo_funcion, fecha_inicio, fecha_fin);
                                listadoResumenRegistradas = enlace.resumenActividadesRegistradasDireccionRangoFecha(codigo_funcion, fecha_inicio, fecha_fin);
                                listadoResumenCorregidas= enlace.resumenActividadesCorregidasDireccionRangoFecha(codigo_funcion, fecha_inicio, fecha_fin);
                            } catch (Exception ex) {
                    ...
                    <section class="section">
                        <div class="section-header">
                            <h1>Monitoreo de actividades <%= enlace.direccionPerteneceUsuario(codigo_funcion)%></h1>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                ...
                                                <div class="summary-item">
                                                    <div class="mb-4 mt-4">
                                                        <div class="text-small float-right font-weight-bold text-muted"><button class="btn" type="button" href="javascript:;" onclick="mostrarDatosRegistradas('<%= fecha_inicio%>', '<%= fecha_fin%>', '<%= codigo_funcion%>')" data-toggle="modal" data-target="#modalDatos"><%= cantidad_registradas%></button></div>
                                                        ...
                                                        <div class="text-small float-right font-weight-bold text-muted"><button class="btn" type="button" href="javascript:;" onclick="mostrarDatosAprobadas('<%= fecha_inicio%>', '<%= fecha_fin%>', '<%= codigo_funcion%>')" data-toggle="modal" data-target="#modalDatos"><%= cantidad_aprobadas%></button></div>
                                                    ...
                                                    <div>
                                                        <label><br>TOTAL DE ACTIVIDADES: <%= enlace.cantidadActividadesDireccionCodigoFuncion(codigo_funcion, fecha_inicio, fecha_fin) %></br></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                        ...
                                        <%}%>
                                        <div class="card-body">
                                            <form action="administrar_actividad.control?accion=filtrar_monitor" method="post">
                                                <div class="row">
                                                    <%if (ind != 0) {%>
                                                    <div class="col-2">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-resumen">
                                                            ...
                                                            <tfoot>
                                                                <tr>
                                                                    <td><b>TOTALES</b></td>
                                                                     <td><b><%= enlace.numeroAccesosIntranetRangoFechaDireccion(codigo_funcion,fecha_inicio,fecha_fin) %></b></td>
                                                                    <td><b><%= enlace.numeroActividadesRangoFechaDireccion(codigo_funcion,fecha_inicio,fecha_fin) %></b></td>
                                                                    <td><b><%= enlace.numeroRegistroActividadesCorregidasRangoFechaDireccion(codigo_funcion,fecha_inicio,fecha_fin) %></b></td>
                                                                    <td><b><%= enlace.totalHorasActividadesRangoDireccion(codigo_funcion,fecha_inicio,fecha_fin) %></b></td>
                                                                </tr>
                                                            </tfoot>
                                                            <tfoot>
                                                                <tr>
