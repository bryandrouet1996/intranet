...
<%
    ...
    try {
        ...
        if (sesion.getAttribute("carga") != null) {
            res = sesion.getAttribute("carga").toString();
            sesion.removeAttribute("carga");
        }
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Carga Riesgos</title>
        <!-- General CSS Files -->
    ...
    <body>
                        ...
                        <div class="section-body">        
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form id="formRiesgos" action="carga_riesgos.control?accion=cargar" method="post" enctype="multipart/form-data" class="needs-validation" novalidate="">
                                                <div class="row">
                                                    <div class="form-group col-md-6" hidden="">
                                                        <label>id usuario</label>
                                                        <input type="text" class="form-control" placeholder="Detalle claramente la problemática." name="idusu" id="idusu" required="" readonly="" value="<%= informacion.getId_usuario()%>">
                                                        <div class="invalid-feedback">
                                                            No ha ninguna fecha
                                                        </div>
                                                    </div>   
                                                    <div class="form-group col-md-5">
                                                        <label>Archivo .xls (tamaño máximo 500 MB)</label>
                                                        <input type="file" class="form-control" name="adjunto" id="adjunto" required="" onchange="validateSize()">
                                                        <div class="invalid-feedback">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <button type="submit" class="btn btn-primary"><i class="fas fa-check-circle"></i> Cargar</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
        ...
        <script type="text/javascript">
            function validateSize() {
                ...
                if (!(regex.test(ext))) {
                    swal("Formato incorrecto", "El formato del archivo debe ser .xls (Excel 97-2003)", {
                        icon: "warning",
                        buttons: {
                            confirm: {
                    ...
                    swal("Tamaño excedido", "El archivo excede el tamaño máximo de 500 MB", {
                        icon: "warning",
                        buttons: {
                            confirm: {
                                className: 'btn btn-warning'
            ...
            window.onload = function() {
                if('<%=res%>'==='x'){
                    swal("Carga completada", "Los datos fueron cargados exitosamente", {
                        icon: "success",
                        buttons: {
                            confirm: {
