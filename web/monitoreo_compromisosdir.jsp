...
<%
    ...
    try {
        ...
        id_acta = Integer.parseInt(request.getParameter("ic"));
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Reuniones - Detalle de compromisos</h1>
                        </div>
                        <div class="section-body">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-12">
                                    <div class="summary-chart active" data-tab-group="summary-tab" id="summary-chart">
                                        <canvas id="myChart331" height="70"></canvas>
                                    </div>
                                </div>
                            </div>
                            <br>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="table-1">
                                                ...
                                                <tbody>
                                                    <%if (!listadoCompromisos.isEmpty()) {%>
                                                    <%for (compromiso_acta elem : listadoCompromisos) {
                                                            String estado = null;
                                                            usuario usu = enlace.buscar_usuarioID(elem.getId_responsable());
                                                            String responsable = usu.getApellido() + " " + usu.getNombre();
                                                    %>
                                                    <tr>
                                                        <td><%= elem.getFecha_cumplimiento() %></td>
                                                        <td><%= elem.getDescripcion() %></td>
                                                        <td><%= responsable %></td>
                                                        <td>
                                                            <div class="progress mb-3">
                                                                    <div class="progress-bar" role="progressbar" aria-valuenow="0" data-width="<%= elem.getGrado() %>" aria-valuemin="0" aria-valuemax="100">
                                                                        <%= elem.getGrado() %> 
                                                                    </div>
                                                                </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <%if(elem.getEstado() != 0){%>
                                                            <a href="javascript:" type="button" onclick="cargarDetalleCompromiso(<%= elem.getId_compromiso() %>)" data-toggle="modal" data-target="#modalDetalleCompromiso" class="btn btn-primary btn-sm"><i class="fas fa-file-alt" data-toggle="tooltip" data-original-title="Ver verificables"></i></a>
                                                            <%}else{%>
                                                            <a href="javascript:" type="button" class="btn btn-primary btn-sm disabled" ><i class="fas fa-file-alt" data-toggle="tooltip" data-original-title="Ver verificables"></i></a>
                                                            <%}%>
                                                        </td>
                                                    </tr>
                                                    <%}%>
