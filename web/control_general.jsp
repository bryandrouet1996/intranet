...
<%
    ...
    try {
        ...
        if (request.getParameter("direccion") != null) {
            ...
            direccion_buscada = enlace.direccionPerteneceUsuario(dire);
            listadoUsuarios = enlace.listadoUsuariosActivosCodigoFuncion(dire);
        }
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Control general de actividades</title>
    ...
    <body>
        ...
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <%if (request.getParameter("direccion") != null) {%>
                            <h1>Control general de actividades | <%= direccion_buscada%></h1>
                            <%} else {%>
                            <h1>Control general de actividades</h1>
                            <%}%>
                        </div>
                        <div class="section-body">
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="row" action="administrar_actividad.control?accion=filtrar_ctgeneral" method="post">
                                                <%if (request.getParameter("fecha_inicio") == null && request.getParameter("fecha_fin") == null) {%>
                                                <div class="col-2">
                                            ...
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="fas fa-users"></i> Listado de funcionarios</a>
                                                </li>
                                            </ul>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-striped" id="table-resumen">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <%for (usuario funcionario : listadoUsuarios) {
                                                                        int ingresos_intranet = enlace.numeroAccesosIntranetRangoFecha(funcionario.getId_usuario(), fecha_inicio, fecha_fin);
                                                                        int numero_actividades = enlace.numeroRegistroActividadesRangoFecha(funcionario.getId_usuario(), fecha_inicio, fecha_fin);
                                                                        String horas = enlace.totalHorasActividadesRango(funcionario.getId_usuario(), fecha_inicio, fecha_fin);
                                                                        if (horas == null) {
                                                                            horas = "sin registros";
                                                                        }
                                                                %>
                                                                <tr>
                                                                    <td><a href="javascript:" onclick="mostrarListadoActividades('<%= fecha_inicio%>', '<%= fecha_fin%>', '<%= funcionario.getId_usuario() %>')" data-toggle="modal" data-target="#modalListadoActividades"><%= funcionario.getApellido() %> <%= funcionario.getNombre() %></a></td>
                                                                    <td><a type="button" href="javascript:" onclick="mostrarDatosAccesos('<%= fecha_inicio %>', '<%= fecha_fin %>', '<%= funcionario.getId_usuario() %>')" data-toggle="modal" data-target="#modalAccesos"><%= ingresos_intranet %></a></td>
                                                                    <td><a type="button" href="javascript:" onclick="mostrarDatosIndividual('<%= fecha_inicio%>', '<%= fecha_fin%>', '<%= funcionario.getId_usuario() %>')" data-toggle="modal" data-target="#modalIndividual"><%= numero_actividades %></a></td>
                                                                    <td><%= horas %></td>
                                                                    <td>
                                                                        <a href="listado_detalleactividades.jsp?iu=<%= funcionario.getId_usuario() %>&fecha_inicio=<%= fecha_inicio %>&fecha_fin=<%= fecha_fin %>" class="btn btn-primary btn-sm"><i class="fas fa-eye" data-toggle="tooltip" data-original-title="Ver detalles"></i></a>
                                                                        <a target="_blank" href="reporteActividad.control?accion=actividades&txtidusuario2=<%= funcionario.getId_usuario() %>&txtin2=<%= fecha_inicio %>&txtfi2=<%= fecha_fin %>" class="btn btn-primary btn-sm"><i class="fas fa-print" data-toggle="tooltip" data-original-title="Generar reporte"></i></a>
                                                                    </td>
                                                                </tr>
                                                                <%}%>
                                                                <%}%>
                ...
                <div class="modal fade" id="modalListadoActividades" tabindex="-1" role="dialog" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">
                            ...
                            <div class="modal-body">
                                <form>
                                    <div class="form-row">
                                        <div class="form-group col-md-12" id="listadoactividades">
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
        ...
        <script>
                                                                        ...
                                                                        function mostrarListadoActividades(fecha_inicio, fecha_fin, id_usuario) {
                                                                            $("#listadoactividades").load("listadoActividades_funcionario.jsp?fechi=" + fecha_inicio + "&fechf=" + fecha_fin + "&iu=" + id_usuario);
                                                                        }
