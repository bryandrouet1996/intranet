...
<%
    ...
    try {
        id = Integer.parseInt(sesion.getAttribute("usuario_dir").toString());
                ...
                <div class="main-sidebar sidebar-style-2">
                    <aside id="sidebar-wrapper">
                        ...
                        <div class="sidebar-brand sidebar-brand-sm">
                            <a href="principal_dir.jsp">DS</a>
                        </div>
                        <ul class="sidebar-menu">
                            <li class="dropdown active">
                                <a href="principal_dir.jsp" class="nav-link"><i class="fas fa-home"></i><span>Principal</span></a>
                            </li>
