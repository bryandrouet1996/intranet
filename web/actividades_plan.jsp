...
<%
    ...
    int id_plan = 0;
    ArrayList<actividad_plan> listadoActividadesPlan = null;
    ArrayList<tipo_actividad> listadoTipoActividades = null;
    ArrayList<orientador_gasto> listadoOrientadorActividades = null;
    int id_actul = 0;
    ...
    try {
        ...
        listadoActividadesPlan = enlace.listadoActividadesPlanOperativo(id_plan);
        listadoTipoActividades = enlace.listadoTipoActividades();
        listadoOrientadorActividades = enlace.listadoOrientadorActividades();
        id_actul = enlace.idUltimaActividadPlanID(id_plan);
        acti_rec = enlace.ObtenerActividadePlanOperativoID(id_actul);
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Mis actividades de plan operativo</title>
                        ...
                        <div class="section-header">
                            ...
                            <div class="section-header-breadcrumb">
                                <div class="flex-column activities">
                                    <a href="javascript:" data-toggle="modal" data-target="#modalRegistroActividad" class="btn btn-primary" > <i class="far fa-calendar-plus"></i> Crear actividad</a>   
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4>Listado de actividades</h4> <a class="btn btn-icon icon-left active" id="alertPoa"> 
