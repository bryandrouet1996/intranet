    ...
    try {
        ...
        if (request.getParameter("id_documento") != null) {
            ...
            for(DestinatarioDocumento dd : doc.getIds_destinatarios()){
                for(usuario d : listadoDestinatarios){
                    if(dd.getEstado() != 0 && dd.getId_usuario() == d.getId_usuario()){
                        listadoDestinatarios.remove(d);
                        break;
                    }
                }
...
<html lang="es">
            ...
            <table class="table table-striped" id="table-x-reasignar">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>
                           <a type="button" onclick="reasignar_recibido(<%= u.getId_usuario()%>)" class="btn btn-primary btn-sm active"><i class="fas fa-check-circle" data-toggle="tooltip" data-original-title="Reasignar"></i></a>
                        </td>
                    </tr>
                    <%}%>
                </tbody>
    ...
    <script type="text/javascript">
      ...
      function reasignar_recibido(nuevo_destinatario){
            Swal.fire({
                ...
                if(result.isConfirmed){
                    ...
                    $.post('administrar_documento.control?accion=reasignar_recibido', {
