...
<%
    ...
    ArrayList<PermisoECU> listadoPendientes = null, listadoRevisadas = null, listadoRechazadas = null;
    ...
    try {
        ...
        listadoPendientes = enlace.listadoPermisoHorasECU(informacion.getId_usuario(), 0);
        listadoRevisadas = enlace.listadoPermisoHorasECU(informacion.getId_usuario(), 1);
        listadoRechazadas = enlace.listadoPermisoHorasECU(informacion.getId_usuario(), 2);
        ...
        boolean pendVacas = false;
        for (PermisoECU p : listadoPendientes) {
            if (p.getIdMotivo() == 1) {
                pendVacas = true;
                break;
            }
        }
        checkPendientes = (disponibilidadMinutos + dias_disponibles > 0) && !pendVacas;
...
<html lang="en">
    <head>
        ...
        <title>Intranet Alcaldía - Permisos (horario rotativo)</title>
        <!-- General CSS Files -->
                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="table-x">
                                                ...
                                                <tbody>
                                                    <%for (PermisoECU pendientes : listadoPendientes) {
                                                            motivo_permiso mot = enlace.buscarMotivoId(pendientes.getIdMotivo());
                                                    %>
                                                    <tr>
                                                        <td style="width: 5%"><%= pendientes.getId()%></td>
                                                        <td style="width: 15%"><%= pendientes.getFechaSoli()%></td>
                                                        <td style="width: 15%"><%= pendientes.getInicio()%></td>
                                                        <td style="width: 15%"><%= pendientes.getFin()%></td>
                                                        <td style="width: 10%"><%= mot.getDescripcion()%></td>
                                                        <td style="width: 10%"><%= pendientes.getTiempoSoli()%></td>
                                                        <td style="width: 30%">
                                                            <%if (pendientes.getAdjunto() != null) {%>
                                                            <a target="_blank" href="descargar_archivo.control?accion=descargar_archivo&ruta=<%= pendientes.getAdjunto()%>" class="btn btn-primary btn-sm active"><i class="fas fa-paperclip" data-toggle="tooltip" data-original-title="Descargar adjunto"></i></a>
                                                                <%}%>
                                                            <a href="javascript:" type="button" onclick="eliminarPermiso(<%= pendientes.getId()%>)"  class="btn btn-primary btn-sm active"><i class="fa fa-times" data-toggle="tooltip" data-original-title="Eliminar"></i></a>
                                                        </td>
                                                    </tr>
                                                    <%}%>
                                                </tbody>
                                    ...
                                    <div class="tab-pane fade" id="revi" role="revipanel" aria-labelledby="revi-tab">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="table-2">
                                                ...
                                                <tbody>
                                                    <%for (PermisoECU revisadas : listadoRevisadas) {
                                                            motivo_permiso mot = enlace.buscarMotivoId(revisadas.getIdMotivo());
                                                            RevisionHoras elemen = enlace.obtenerRevisionHorasECU(revisadas.getId());
                                                            usuario revisa = enlace.buscar_usuarioID(elemen.getId_usuario());
                                                    %>
                                                    <tr>
                                                        <td style="width: 5%"><%= revisadas.getId()%></td>
                                                        <td style="width: 15%"><%= revisadas.getFechaSoli()%></td>
                                                        <td style="width: 15%"><%= revisadas.getInicio()%></td>
                                                        <td style="width: 15%"><%= revisadas.getFin()%></td>
                                                        <td style="width: 10%"><%= mot.getDescripcion()%></td>
                                                        <td style="width: 10%"><%= revisadas.getTiempoSoli()%></td>
                                                        <td style="width: 30%">
                                                            <%if (revisadas.getConfirmacion() != null) {%>
                                                            <a target="_blank" href="descargar_archivo.control?accion=descargar_archivo&ruta=<%= revisadas.getConfirmacion()%>" class="btn btn-primary btn-sm active"><i class="fas fa-file-download" data-toggle="tooltip" data-original-title="Descargar formulario"></i></a>
                                                                <%}%>                                                            
                                                            <a href="javascript:" type="button" data-toggle="modal" data-target="#modalDetalleRevision" data-revisa="<%= revisa.getApellido() + " " + revisa.getNombre()%>" data-fech="<%= elemen.getFecha_registro()%>" class="btn btn-primary btn-sm active"><i class="fa fa-eye" data-toggle="tooltip" data-original-title="Ver detalles"></i></a>
                                                                <%if (revisadas.getAdjunto() != null) {%>
                                                            <a target="_blank" href="descargar_archivo.control?accion=descargar_archivo&ruta=<%= revisadas.getAdjunto()%>" class="btn btn-primary btn-sm active"><i class="fas fa-paperclip" data-toggle="tooltip" data-original-title="Descargar adjunto"></i></a>
                                                                <%}%>
                                                        </td>
                                                    </tr>
                                                    <%}%>
                                    ...
                                    <div class="tab-pane fade" id="reject" role="tabpanel" aria-labelledby="reject-tab">
                                        <div class="table-responsive">
                                            <table class="table table-striped" id="table-4">
                                                ...
                                                <tbody>
                                                    <%for (PermisoECU rechazadas : listadoRechazadas) {
                                                            motivo_permiso mot = enlace.buscarMotivoId(rechazadas.getIdMotivo());
                                                            rechazo_solicitud elem = enlace.obtenerRechazoSolicitudHorasECU(rechazadas.getId());
                                                            usuario rechaza = enlace.buscar_usuarioID(elem.getId_rechaza());
                                                    %>
                                                    <tr>
                                                        <td style="width: 5%"><%= rechazadas.getId()%></td>
                                                        <td style="width: 15%"><%= rechazadas.getFechaSoli()%></td>
                                                        <td style="width: 15%"><%= rechazadas.getInicio()%></td>
                                                        <td style="width: 15%"><%= rechazadas.getFin()%></td>
                                                        <td style="width: 10%"><%= mot.getDescripcion()%></td>
                                                        <td style="width: 10%"><%= rechazadas.getTiempoSoli()%></td>
                                                        <td style="width: 30%">
                                                            <a href="javascript:" type="button" data-toggle="modal" data-target="#modalDetalleRechazo" data-rechaza="<%= rechaza.getApellido() + " " + rechaza.getNombre()%>" data-descri="<%= elem.getRazon()%>" data-fech="<%= elem.getFecha_creacion()%>" class="btn btn-primary btn-sm active"><i class="fa fa-eye" data-toggle="tooltip" data-original-title="Ver detalles"></i></a>
                                                                <%if (rechazadas.getAdjunto() != null) {%>
                                                            <a target="_blank" href="descargar_archivo.control?accion=descargar_archivo&ruta=<%= rechazadas.getAdjunto()%>" class="btn btn-primary btn-sm active"><i class="fas fa-paperclip" data-toggle="tooltip" data-original-title="Descargar adjunto"></i></a>
                                                                <%}%> 
                                                        </td>
                                                    </tr>
                                                    <%}%>
                ...
                <div class="modal-dialog modal-lg" role="dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <%} else {%>
                            <form id="formhoras" action="administrar_permiso.control?accion=registro_horas_ecu" method="post" enctype="multipart/form-data" class="needs-validation">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control" onchange="seleccionMotivoPermisoHoras()" name="combomotivo" id="combomotivo" required>
                                            ...
                                            <option value="<%= busq.getId_motivo()%>" <%=busq.getId_motivo() == 1 && !checkPendientes ? "disabled=" : ""%>><%= busq.getDescripcion()%></option>
                                            <%}
                                                }%>
                                        </select>
                                    </div>
                                                        ...
                                                        success: function (response) {
                                                            if (response) {
                                                                Swal.fire({
                                                                    ...
                                                                    location.href = "permiso_horas_ecu_x.jsp";
                                                                });
                                                            } else {
                                                                Swal.fire({
                                                                    title: 'Error',
                                            ...
                                            function eliminarPermiso(id_permiso) {
                                                Swal.fire({
                                                    ...
                                                    if (willDelete.isConfirmed) {
                                                        ...
                                                        $.post('administrar_permiso.control?accion=eliminar_horas_ecu', {
