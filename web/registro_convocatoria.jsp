...
<%
    ...
    try {
        ...
        if(funcion_usuario.equalsIgnoreCase("coordinador")||funcion_usuario.equalsIgnoreCase("director")){
            listadoDirectores = enlace.listadosDirectoresDireccionesUnidades();
        }else if(funcion_usuario.equalsIgnoreCase("encargado")){
            listadoDirectores = enlace.listadoUsuariosDireccionCodigoFuncion(codigo_funcion);
        }
                ...
                <div class="main-content">
                    <section class="section">
                        ...
                        <div class="section-header">
                            <h6><a href="listado_convocatorias.jsp">Listado convocatorias</a> > Ingresar nueva convocatoria</h6>
                        </div>
                        <div class="section-body">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form class="needs-validation" id="formconvocatoria" action="administrar_acta.control?accion=registro_convocatoria" method="post" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-2" hidden>
                                                            <label>Id convocatoria</label>
                                                            <input type="text" class="form-control" name="txticconv" id="txticconv" value="0" required>
                                                        </div>
                                                        <div class="form-group col-md-2" hidden>
                                                            <label>Id usu</label>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            ...
                                                            <input type="text" class="form-control datepicker" name="txtfechaconvocatoria" id="txtfechaconvocatoria" required>
                                                        </div>
                                                        <div class="form-group col-md-10">
                                                            <label>*Asunto</label>
                                                            <input type="text" class="form-control" name="txtasunto" id="txtasunto" required="" placeholder="Ingrese una breve descripción">
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                        ...
                                                        <div class="form-group col-md-8">
                                                            <label>*Lugar</label>
                                                            <input type="text" class="form-control"  name="txtlugar" id="txtlugar" value="Sala institucional de edificio principal" required>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                                <label>*Orden del día</label>
                                                                <textarea class="form-control" rows="5" name="areaobservacion" id="areaobservacion" required placeholder="Detalle el orden del día de la reunión a realizar"></textarea> 
                                                            </div>
                                                        <div class="form-group col-md-12">
                                                            <label>*Asistentes</label>
                                                            <select class="form-control select2" name="comboasistentes" id="comboasistentes" multiple="multiple" required >
                                                                <option value="0">TODOS</option>
                                                                <%for (usuario func : listadoDirectores) {%>
                                                ...
                                                <div class="card-footer text-right">
                                                    <button onclick="notificacionFuncionarios()" class="btn btn-primary btn-block btn-lg" type="submit"><i class="fas fa-save"></i> Registrar</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <%}else{
                        convocatoria elem = enlace.buscarConvocatoriaID(id_convocatoria);
                    %>
                    <div class="section-header">
                            <h6><a href="listado_convocatorias.jsp">Listado convocatorias</a> > Actualizar convocatoria</h6>
                        </div>
                        <div class="section-body">
                            <div class="row">
                                <div class="col-12 col-md-6 col-lg-12">
                                            ...
                                            <form class="needs-validation" id="formconvocatoria" action="administrar_acta.control?accion=registro_convocatoria" method="post" enctype="multipart/form-data">
                                                <div class="card-body">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-2" hidden>
                                                            <label>Id convocatoria</label>
                                                            <input type="text" class="form-control" name="txticconv" id="txticconv" value="<%= elem.getId_convocatoria() %>" required>
                                                        </div>
                                                        <div class="form-group col-md-2" hidden>
                                                            <label>Id usu</label>
                                                            <input type="text" class="form-control" name="txtiusu" id="txtiusu" value="<%= informacion.getId_usuario() %>" required>
                                                        ...
                                                        <div class="form-group col-md-2">
                                                            <label>*Fecha convocatoria</label>
                                                            <input type="text" class="form-control datepicker" name="txtfechaconvocatoria" id="txtfechaconvocatoria" value="<%= elem.getFecha_convocatoria() %>" required>
                                                        </div>
                                                        <div class="form-group col-md-10">
                                                            <label>*Asunto</label>
                                                            <input type="text" class="form-control" name="txtasunto" id="txtasunto" required="" placeholder="Ingrese una breve descripción" value="<%= elem.getAsunto() %>" >
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label>*Hora de inicio</label>
                                                            <input type="time" class="form-control" name="txthorainicio" id="txthorainicio" required value="<%= elem.getHora_inicio() %>" >
                                                        </div>
                                                        <div class="form-group col-md-2">
                                                            <label>*Hora de fin</label>
                                                            <input type="time" class="form-control" onchange="validarhoras()" name="txthorafin" id="txthorafin" value="<%= elem.getHora_fin() %>"  required>
                                                        </div>
                                                        <div class="form-group col-md-8">
                                                            <label>*Lugar</label>
                                                            <input type="text" class="form-control"  name="txtlugar" id="txtlugar" value="<%= elem.getLugar() %>"  required>
                                                        </div>
                                                        <div class="form-group col-md-12">
                                                                <label>*Orden del día</label>
                                                                <textarea class="form-control" rows="5" name="areaobservacion" id="areaobservacion" required placeholder="Detalle el orden del día de la reunión a realizar"><%= elem.getOrden_dia() %></textarea> 
                                                            </div>
                                                        <div class="form-group col-md-12">
                                                            <label>*Asistentes</label>
                                                            <select class="form-control select2" name="comboasistentes" id="comboasistentes" multiple="multiple" required >
                                                                <option value="0">TODOS</option>
                                                                <%for (usuario func : listadoDirectores) {%>
                                                                <%if(enlace.esConvocadoUsuarioID(id_convocatoria, func.getId_usuario())){%>
