...
<%
    ...
    try {
        ...
        if (sesion.getAttribute("carga_gaceta") != null) {
            res = sesion.getAttribute("carga_gaceta").toString();
            sesion.removeAttribute("carga_gaceta");
        }
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Carga Gaceta Tributaria</title>
        <!-- General CSS Files -->
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Gaceta tributaria - Carga de datos</h1>
                        </div>
                        <div class="section-body">        
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="GacetaTributaria.control?accion=cargar" method="post" enctype="multipart/form-data" class="needs-validation">
                                                <div class="row">
                                                    <div class="form-group col-md-5">
                                                        <label>Archivo .xls (tamaño máximo 5 MB)</label>
        ...
        <script type="text/javascript">
            function validateSize() {
                ...
                if (!(regex.test(ext))) {
                    ...
                    swal("Tamaño excedido", "El archivo excede el tamaño máximo de "+MAX_FILE_SIZE+" MB", {
                        icon: "warning",
                        buttons: {
                            confirm: {
                                className: 'btn btn-warning'
            ...
            window.onload = function () {
                if ('<%=res%>' === 'x') {
                    ...
                    swal("Error al cargar", "Ocurrió un error al cargar los datos", {
                        icon: "error",
                        buttons: {
                            confirm: {
                                className: 'btn btn-success'
