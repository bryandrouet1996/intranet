...
<html lang="en">
    <head>
        ...
        <title>Intranet Alcaldía - Contactos</title>
        <!-- General CSS Files -->
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Reuniones - Mis contactos</h1>
                            <div class="section-header-breadcrumb">
                                <div class="flex-column activities">
                                    <a href="javascript:" class="btn btn-primary" > <i class="fas fa-plus"></i> Nueva lista</a>   
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="pricing pricing-highlight">
                                    <div class="pricing">
                                        ...
                                        <div class="pricing-cta">
                                            <a href="#">Ir a listado <i class="fas fa-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
