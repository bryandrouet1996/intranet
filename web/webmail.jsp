...
<html lang="en">
    <head>
        ...
        <title>Intranet Alcaldía - Correo institucional</title>
        <!-- General CSS Files -->
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Correo institucional Webmail</h1>
                        </div>
                        <div class="section-body">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe class="embed-responsive-item" src="https://www.esmeraldas.gob.ec:2096/login/?user=<%= informacion.getCorreo()%>&pass=<%= enlace.webmailClaveUsuario(informacion.getId_usuario())%>" allowfullscreen></iframe>
                            </div>
                        </div>
                    </section>
                </div>
