...
<%
    ...
    ArrayList<TipoManual> tiposManuales = new ArrayList<>();
    ...
    try {
        ...
        tiposManuales = enlace.getTiposManuales();
        manuales = enlace.getManuales();       
        versiones = enlace.getVersionesManuales(informacion.getId_usuario());
    } catch (Exception e) {
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Repositorio</title>
        <!-- General CSS Files -->
        ...
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                        ...
                        <div class="section-header">
                            ...
                            <div class="section-header-breadcrumb">
                                <div class="flex-column activities">
                                    <a href="javascript:" class="btn btn-primary" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalNuevaVersion"> <i class="fas fa-plus"></i> Nueva versión</a>
                                </div>
                                <div class="flex-column activities">
                                    <a href="javascript:" class="btn btn-primary" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalNuevoDocumento"> <i class="fas fa-plus"></i> Nuevo documento</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog modal-lg" role="dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <p class="small"></p>
                                    <form id="formVersion" action="administrar_man.control?accion=registrar" method="post" enctype="multipart/form-data" class="needs-validation">
                                        <div class="form-row">
                                            <div class="form-group col-md-2" hidden>
                                                <input type="text" name="idUsu" id="idUsu" value="<%= informacion.getId_usuario()%>">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Documento *</label>
                                                <select class="form-control" name="cmbMan" id="cmbMan" required>
                                                    <option selected="" disabled="" value="">Seleccione documento</option>
                                                    <%for (Manual m : manuales) {%>
                                                        <option value="<%= m.getId()%>"><%= m.getTitulo() + " (código: " + m.getCodigo() + ") " + " - " + m.getTipo() + " (versión: " + m.getVersion() + ")"%></option>
                                                    <%}%>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-12">
                                                ...
                                                <div class="invalid-feedback">
                                                    No ha ingresado ningún título
                                                </div>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Descripción *</label>
                                                <textarea type="text" class="form-control" placeholder="Descripción" name="desc" id="desc" required=""></textarea>
                                                <div class="invalid-feedback">
                                                    No ha ingresado ninguna descripción
                                                </div>
                                            </div>
                                            <div class="form-group col-md-12">
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" id="btnVersion" value="Upload" class="btn btn-primary">Guardar</button>
                    ...
                    <div class="modal fade"  role="dialog" aria-hidden="true" id="modalNuevoDocumento">
                        <div class="modal-dialog modal-lg" role="dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title text-center">
                                ...
                                <div class="modal-body">
                                    <p class="small"></p>
                                    <form id="formDoc" action="administrar_man.control?accion=registrar_doc" method="post" enctype="multipart/form-data" class="needs-validation">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select class="form-control" name="cmbTipo" id="cmbTipo" required>
                                                    ...
                                                    <%for (TipoManual t : tiposManuales) {%>
                                        ...
                                        <div class="modal-footer">
                                            <button type="submit" id="btnDoc" value="Upload" class="btn btn-primary">Guardar</button>
                                            <button type="button" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </form>
                                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#formVersion').submit(function (event) {
                    var btn = document.getElementById("btnVersion");
                    btn.hidden = true;
