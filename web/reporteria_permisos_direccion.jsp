...
<%
    ...
    ArrayList<UsuarioIESS> listadoUsuarios = null;
    ...
    try {
        ...
        if (!(enlace.verificarUsuarioCumpleRol(id, "administrador") || enlace.verificarUsuarioCumpleRol(id, "director") || enlace.verificarUsuarioCumpleRol(id, "encargado_permisos") || enlace.verificarUsuarioCumpleRol(id, "ausencias_direccion"))) {
            throw new Exception("Rol no habilitado");
        }
        listadoUsuarios = oracle.getUsuarios();
        ...
        String codigoDir = oracle.consultarCodigoDireccion(oracle.consultarDireccionUsuario(Integer.parseInt(informacion.getCodigo_usuario())));
        listadoAuditoria = request.getParameter("txtini") == null ? (tecnico == -1 ? oracle.getPermisosDireccion(codigoDir) : oracle.getPermisosDireccion(codigoDir, tecnico)) : (tecnico == -1 ? oracle.getPermisosDireccion(codigoDir, fecha_inicio, fecha_fin) : oracle.getPermisosDireccion(codigoDir, tecnico, fecha_inicio, fecha_fin));
...
<html lang="es">
    <head>
        ...
        <title>Intranet Alcaldía - Reportería de permisos dirección</title>
        <!-- General CSS Files -->
                ...
                <div class="main-content">
                    <section class="section">
                        <div class="section-header">
                            <h1>Reportería de permisos aprobados - <%= oracle.consultarDireccionUsuario(Integer.parseInt(informacion.getCodigo_usuario()))%></h1>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        ...
                                                        <select class="form-control select2" name="tecnico" id="tecnico" required="">
                                                            ...
                                                            <%for (UsuarioIESS u : listadoUsuarios) {%>
                                                            <option value="<%= u.getCodigo()%>" <%=tecnico == u.getCodigo() ? "selected" : ""%>><%= u.getNombres()%></option>
                                                            <%}%>
                                                        </select>
                                                    </div>
                                                    <div class="col-3">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true"><i class="fas fa-users"></i> Registros <%=fecha_inicio == null && fecha_fin == null ? "recientes" : "consultados"%> <%if (listadoAuditoria.size() != 0) {%><span class="badge badge-primary"><%= listadoAuditoria.size()%></span><%}%></a>
                                                </li>
                                            </ul>
